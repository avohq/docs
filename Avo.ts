 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/D8s8L98F2/events/2ec69c49-7376-4821-b584-8399845d33d7}
 */
export function signUpStarted(properties: SignUpStartedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "2ec69c49-7376-4821-b584-8399845d33d7", "006c3fdb9d103c893bc7c840055a4a24bbe97b8b83892ee41dccbdd4ab6c152c", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Sign Up Started", eventProperties, "2ec69c49-7376-4821-b584-8399845d33d7", "006c3fdb9d103c893bc7c840055a4a24bbe97b8b83892ee41dccbdd4ab6c152c");
    }
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/D8s8L98F2/events/0FvnJgpVbz}
 */
export function contentCopied(properties: ContentCopiedProperties) {
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Content Copied", eventProperties, "0FvnJgpVbz", "a1957ef9b84b8f29012e1e9f97ff61250039ea456028ff892b1392f196baee65");
    }
    // destination SegmentInspectorForDocs
 ...
 * @param properties.path: pathname from the URL, e.g. 'https://www.avo.app/docs/quickstart/' -> 'docs/quickstart'
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/D8s8L98F2/events/J4cW6PmriY}
 */
export function docsPageViewed(properties: DocsPageViewedProperties) {
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Docs Page Viewed", eventProperties, "J4cW6PmriY", "6d8c90f03c2974c66a50d66baf1960bbfee24f1d21df493811d0917fdecfaa22");
    }
    // destination SegmentInspectorForDocs
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/D8s8L98F2/events/Pjs0MGxPME}
 */
export function docsPageErrored(properties: DocsPageErroredProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "Pjs0MGxPME", "34e042e4d14cf388e917a678968cfa23b16173fcca2d6acffffd6fc76ae99c6a", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Docs Page Errored", eventProperties, "Pjs0MGxPME", "34e042e4d14cf388e917a678968cfa23b16173fcca2d6acffffd6fc76ae99c6a");
    }
    // destination SegmentInspectorForDocs
...
// AVOMODULEMAP:"Avo"
// AVOEVENTMAP:["signUpStarted","contentCopied","docsPageViewed","docsPageErrored"]
