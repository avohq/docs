// Generated by Avo VERSION 83.189.0. You should never have to make changes to this file.
...
export function docsPageViewed(properties: DocsPageViewedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "J4cW6PmriY", "74efae2bafcc0ee06a210f59198383ae51fe8b32aa9fd5c43c41c224f410206d", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Docs Page Viewed", {
        ...
        "Client": sysClient,
        "Version": sysVersion,
        }, "J4cW6PmriY", "74efae2bafcc0ee06a210f59198383ae51fe8b32aa9fd5c43c41c224f410206d");
    }
    // destination SegmentInspectorForDocs
...
export function docsSearchInitialized() {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "FWqOBDDhHU", "f7ff502ee62d2a6346e45c1a9537cbbd30a435f6ff445b0fdce7c960ec4cac71", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Docs Search Initialized", {
        "Client": sysClient,
        "Version": sysVersion,
        }, "FWqOBDDhHU", "f7ff502ee62d2a6346e45c1a9537cbbd30a435f6ff445b0fdce7c960ec4cac71");
    }
    // destination SegmentInspectorForDocs
...
export function docsSearchResultSelected(
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "YartShpgKH", "109ccb8a5f4ab6c9beb93863f7e5c17f29483a718cecf78aa48864489d7c1fdb", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Docs Search Result Selected", {
        ...
        "Client": sysClient,
        "Version": sysVersion,
        }, "YartShpgKH", "109ccb8a5f4ab6c9beb93863f7e5c17f29483a718cecf78aa48864489d7c1fdb");
    }
    // destination SegmentInspectorForDocs
...
export function docsSearchAbandoned(properties: DocsSearchAbandonedProperties
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "OPFGpaxOEx", "6a8411cb6edab89d2fd79959b5fb6f241efc3a670b44ac29db9cb434ba91c2dd", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Docs Search Abandoned", {
        ...
        "Client": sysClient,
        "Version": sysVersion,
        }, "OPFGpaxOEx", "6a8411cb6edab89d2fd79959b5fb6f241efc3a670b44ac29db9cb434ba91c2dd");
    }
    // destination SegmentInspectorForDocs
