// Generated by Avo VERSION 83.140.0. You should never have to make changes to this file.
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/taHQT8x7G/events/35_wLFqR0}
 */
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Feedback Given", {
        ...
        "Client": sysClient,
        "Version": sysVersion,
        }, "35_wLFqR0", "b8f0d0d12a358bf6076e8551f9e8f40c235253e2a45267902e08d2c810b281d7");
    }
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/taHQT8x7G/events/0FvnJgpVbz}
 */
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Content Copied", {
        ...
        "Client": sysClient,
        "Version": sysVersion,
        }, "0FvnJgpVbz", "ee3e599ef1957564b241b2aed491d23d2ed99946048bca72856dbb5105a83a35");
    }
    // destination Intercom
    let intercomProperties = {};
 ...
 * @param properties.path pathname from the URL, e.g. "https://www.avo.app/docs/quickstart/" -> "docs/quickstart"
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/taHQT8x7G/events/J4cW6PmriY}
 */
export function docsPageViewed(properties: DocsPageViewedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "J4cW6PmriY", "135df387f3e55d2a0a109e35dac622b2775950aa738410d3979aadbe1edab953", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Docs Page Viewed", {
        ...
        "Client": sysClient,
        "Version": sysVersion,
        }, "J4cW6PmriY", "135df387f3e55d2a0a109e35dac622b2775950aa738410d3979aadbe1edab953");
    }
    // destination Intercom
    let intercomProperties = {};
    ...
    // destination Segment
    Segment.logEvent("Docs Page Viewed", (Object as any).assign({}, eventProperties), {});
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/taHQT8x7G/events/FWqOBDDhHU}
 */
export function docsSearchInitialized() {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "FWqOBDDhHU", "f3afb8fc4e52c8a9c50d422c528c23d30626bcabda0200e795d4a444ad9472ca", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Docs Search Initialized", {
        "Client": sysClient,
        "Version": sysVersion,
        }, "FWqOBDDhHU", "f3afb8fc4e52c8a9c50d422c528c23d30626bcabda0200e795d4a444ad9472ca");
    }
    // destination Intercom
    let intercomProperties = {};
    ...
    // destination Segment
    Segment.logEvent("Docs Search Initialized", (Object as any).assign({}, eventProperties), {});
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/taHQT8x7G/events/YartShpgKH}
 */
export function docsSearchResultSelected(
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "YartShpgKH", "c5e621b7946f00568189f8a4a68bd50d15d1a3be891e1aeae4dda81efed4d17c", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Docs Search Result Selected", {
        ...
        "Client": sysClient,
        "Version": sysVersion,
        }, "YartShpgKH", "c5e621b7946f00568189f8a4a68bd50d15d1a3be891e1aeae4dda81efed4d17c");
    }
    // destination Intercom
    let intercomProperties = {};
    ...
    // destination Segment
    Segment.logEvent("Docs Search Result Selected", (Object as any).assign({}, eventProperties), {});
 ...
 * @param properties.searchResultCount The total number of search results available when the event was sent.
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/taHQT8x7G/events/OPFGpaxOEx}
 */
export function docsSearchAbandoned(properties: DocsSearchAbandonedProperties
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "OPFGpaxOEx", "b85e2cf1d49f56532800d3b722a36d14130f03f1849c2d37c1f20220e627b6ed", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Docs Search Abandoned", {
        ...
        "Client": sysClient,
        "Version": sysVersion,
        }, "OPFGpaxOEx", "b85e2cf1d49f56532800d3b722a36d14130f03f1849c2d37c1f20220e627b6ed");
    }
    // destination Intercom
    let intercomProperties = {};
    ...
    // destination Segment
    Segment.logEvent("Docs Search Abandoned", (Object as any).assign({}, eventProperties), {});
