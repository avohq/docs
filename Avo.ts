// Generated by Avo VERSION 210.64.0. You should never have to make changes to this file.
  ...
  if (_avo_sampling_rate > 0) {
    if (Math.random() < _avo_sampling_rate) {
      ...
      fetch("https://api.avo.app/i", {
        ...
        body: JSON.stringify({
          "ac": "eeTSNDcfKC9e1WPc4r3N",
          "br": "i4zEsOhO6sGOGcLexRuUX",
          "en": env,
          "ev": eventId,
          "ha": hash,
...
export type SchemaTypeType = typeof SchemaType;
export type SchemaTypeValueType = SchemaTypeType[keyof SchemaTypeType];
...
export type AuthenticationConfigType = typeof AuthenticationConfig;
export type AuthenticationConfigValueType = AuthenticationConfigType[keyof AuthenticationConfigType];

export const BranchPromptInteraction = {
  'STAY_ON_MASTER': 'Stay on master',
  'GO_TO_BRANCH': 'Go to branch',
  'DISMISS': 'Dismiss',
  'BYPASS_AS_ADMIN': 'Bypass as admin',
  'REVERT_TO_DRAFT': 'Revert to draft',
} as const;
export type BranchPromptInteractionType = typeof BranchPromptInteraction;
export type BranchPromptInteractionValueType = BranchPromptInteractionType[keyof BranchPromptInteractionType];

export const BranchPromptType = {
  'EDIT_MAIN': 'Edit main',
  'PULL_TO_MAIN': 'Pull to main',
  'REVERT_TO_DRAFT': 'Revert to draft',
} as const;
export type BranchPromptTypeType = typeof BranchPromptType;
export type BranchPromptTypeValueType = BranchPromptTypeType[keyof BranchPromptTypeType];

export const SchemaSubscriptionPlan = {
  'FREE': 'Free',
...
export type SchemaSubscriptionPlanType = typeof SchemaSubscriptionPlan;
export type SchemaSubscriptionPlanValueType = SchemaSubscriptionPlanType[keyof SchemaSubscriptionPlanType];

export const SchemaSubscriptionPlanSlug = {
  'FREE': 'free',
  'FREEV2': 'freev2',
  'SCHOLARSHIP': 'scholarship',
  'STARTER': 'starter',
  ...
  'GROWTHV2': 'growthv2',
  'ENTERPRISE': 'enterprise',
  'ENTERPRISEV2': 'enterprisev2',
  'TEAMV2': 'teamv2',
  'FREEV3': 'freev3',
  'TEAMV3': 'teamv3',
  'TEAMV2ANNUAL': 'teamv2annual',
  'TEAMV3ANNUAL': 'teamv3annual',
} as const;
export type SchemaSubscriptionPlanSlugType = typeof SchemaSubscriptionPlanSlug;
export type SchemaSubscriptionPlanSlugValueType = SchemaSubscriptionPlanSlugType[keyof SchemaSubscriptionPlanSlugType];

export const SchemaBillingStatus = {
  'TEAM': 'Team',
  'TRIAL': 'Trial',
  'FREE': 'Free',
} as const;
export type SchemaBillingStatusType = typeof SchemaBillingStatus;
export type SchemaBillingStatusValueType = SchemaBillingStatusType[keyof SchemaBillingStatusType];

export const SchemaTrialPlan = {
  'SCHOLARSHIP': 'Scholarship',
  'GROWTH': 'Growth',
  'ENTERPRISE': 'Enterprise',
  'FREE': 'Free',
...
export type SchemaTrialPlanType = typeof SchemaTrialPlan;
export type SchemaTrialPlanValueType = SchemaTrialPlanType[keyof SchemaTrialPlanType];

export const SchemaTrialPlanSlug = {
  'FREE': 'free',
  'FREEV2': 'freev2',
  'STARTER': 'starter',
  'SCHOLARSHIP': 'scholarship',
...
export type SchemaTrialPlanSlugType = typeof SchemaTrialPlanSlug;
export type SchemaTrialPlanSlugValueType = SchemaTrialPlanSlugType[keyof SchemaTrialPlanSlugType];
...
export function initAvo(options: {env: AvoEnv;
    ...
    avoLogger?: AvoLogger},
    systemProperties: {client: ClientValueType;
    version: string},
...
export default {
  ...
  BranchPromptInteraction,
  BranchPromptType,
  SchemaSubscriptionPlan,
  SchemaSubscriptionPlanSlug,
  SchemaBillingStatus,
  SchemaTrialPlan,
  SchemaTrialPlanSlug,
}
...
// AVOMODULEMAP:"Avo"
// AVOEVENTMAP:["signUpStarted","branchPromptInteraction","contentCopied","docsPageViewed","docsPageErrored"]
