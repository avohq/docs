// Generated by Avo VERSION 103.43.0. You should never have to make changes to this file.
...
let Mixpanel = {
  ...
  setGroupProperties: function setGroupProperties(groupTypeName: string, groupId: string, groupProperties: object) {
    if (typeof window === 'undefined') { return; }
    (this as any).getInstance().get_group(groupTypeName, groupId).set(groupProperties);
  },
