// Generated by Avo VERSION 113.195.0. You should never have to make changes to this file.
...
export const SiteSection = {
  ...
  'FREE_PLAN': 'Free Plan',
  'FREE_PLAN_FOOTER': 'Free Plan Footer',
  'GROWTH_PLAN_FOOTER': 'Growth Plan Footer',
  'ENTERPRISE_PLAN_FOOTER': 'Enterprise Plan Footer',
  'STARTER_PLAN': 'Starter Plan',
  'STARTER_PLAN_FOOTER': 'Starter Plan Footer',
} as const;
export type SiteSectionType = typeof SiteSection;
export type SiteSectionValueType = SiteSectionType[keyof SiteSectionType];
...
export function initAvo(options: {env: AvoEnv; webDebugger?: boolean;
  ...
  AmplitudeDestination: CustomDestination,
...
(function() {
  ...
  if (!__AVO_NOOP__) {
    ...
    if (__AVO_ENV__ === 'prod') {
      Amplitude && Amplitude.make && Amplitude.make(__AVO_ENV__, "20a050881c2f99ed4850d73230fa1e31");
    } else if (__AVO_ENV__ === 'dev') {
      Amplitude && Amplitude.make && Amplitude.make(__AVO_ENV__, "78f0aa77e1de2125674e4703d5f21460");
    } else {
      Amplitude && Amplitude.make && Amplitude.make(__AVO_ENV__, "staging key");
    }

    Mixpanel = MixpanelDestination;
    if (__AVO_ENV__ === 'prod') {
      Mixpanel && Mixpanel.make && Mixpanel.make(__AVO_ENV__, "b22a20c38601eb0f14364e8cfdfaa415");
    } else if (__AVO_ENV__ === 'dev') {
      Mixpanel && Mixpanel.make && Mixpanel.make(__AVO_ENV__, "3d4e18198e980f120436a561cc7e2a1f");
    } else {
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/aRnjUGETf/events/2ec69c49-7376-4821-b584-8399845d33d7}
 */
export function signUpStarted(properties: SignUpStartedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "2ec69c49-7376-4821-b584-8399845d33d7", "bfb29284b833066337deb340c0c22714f50f5c259f54b16e1fc5c8e793f76cb7", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  eventProperties["Site Section"] = properties.siteSection;
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Sign Up Started", {
        ...
        "Client": sysClient,
        "Version": sysVersion,
        }, "2ec69c49-7376-4821-b584-8399845d33d7", "bfb29284b833066337deb340c0c22714f50f5c259f54b16e1fc5c8e793f76cb7");
    }
    ...
    Amplitude.logEvent("Sign Up Started", (Object as any).assign({}, eventProperties));
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/aRnjUGETf/events/35_wLFqR0}
 */
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/aRnjUGETf/events/0FvnJgpVbz}
 */
 ...
 * @param properties.path: pathname from the URL, e.g. 'https://www.avo.app/docs/quickstart/' -> 'docs/quickstart'
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/aRnjUGETf/events/J4cW6PmriY}
 */
export function docsPageViewed(properties: DocsPageViewedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "J4cW6PmriY", "6d8c90f03c2974c66a50d66baf1960bbfee24f1d21df493811d0917fdecfaa22", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (properties.utmTerm !== undefined && properties.utmTerm !== null) {
    eventProperties["UTM Term"] = properties.utmTerm;
  }
  eventProperties["Path"] = properties.path;
  eventProperties["Client"] = sysClient;
  eventProperties["Version"] = sysVersion;
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Docs Page Viewed", {
        ...
        "Client": sysClient,
        "Version": sysVersion,
        }, "J4cW6PmriY", "6d8c90f03c2974c66a50d66baf1960bbfee24f1d21df493811d0917fdecfaa22");
    }
    // destination SegmentInspectorForDocs
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/aRnjUGETf/events/FWqOBDDhHU}
 */
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/aRnjUGETf/events/YartShpgKH}
 */
 ...
 * @param properties.searchResultCount: The total number of search results available when the event was sent.
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/aRnjUGETf/events/OPFGpaxOEx}
 */
...
// AVOMODULEMAP:"Avo"
// AVOEVENTMAP:["signUpStarted","feedbackGiven","contentCopied","docsPageViewed","docsSearchInitialized","docsSearchResultSelected","docsSearchAbandoned"]
