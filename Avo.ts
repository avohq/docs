// Generated by Avo VERSION 116.124.0. You should never have to make changes to this file.
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/FeaUzLTj-/events/2ec69c49-7376-4821-b584-8399845d33d7}
 */
export function signUpStarted(properties: SignUpStartedProperties) {
  ...
  properties.emailInput !== undefined && properties.emailInput !== null ?
    ...
    eventProperties["Email Input"] = null;
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/FeaUzLTj-/events/0FvnJgpVbz}
 */
 ...
 * @param properties.path: pathname from the URL, e.g. 'https://www.avo.app/docs/quickstart/' -> 'docs/quickstart'
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/FeaUzLTj-/events/J4cW6PmriY}
 */
 ...
 *
 * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/FeaUzLTj-/events/Pjs0MGxPME}
 */
export function docsPageErrored(properties: DocsPageErroredProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    InternalAvoLogger.logEventSent("Docs Page Errored", {
      "Path": properties.path,
      "Error Code": properties.errorCode,
      "Client": sysClient,
      "Version": sysVersion,
      }, {});
    if (__WEB_DEBUGGER__) {
      // Avo web debugger
      _avo_debugger_log("Pjs0MGxPME", "Docs Page Errored", messages, [
      {id: "UT9ZlNsN2", name: "Path", value: properties.path},
      {id: "xlB65Vu0P", name: "Error Code", value: properties.errorCode},
      {id: "9e5c4ff5-d5f6-4e82-b061-d5fa02755aae", name: "Client", value: sysClient},
      {id: "2fad5bf3-7782-49a2-acc2-825daf823095", name: "Version", value: sysVersion},
      ], [], []);
    }
  ...
  let eventProperties: any = {};
  eventProperties["Path"] = properties.path;
  eventProperties["Error Code"] = properties.errorCode;
  eventProperties["Client"] = sysClient;
  eventProperties["Version"] = sysVersion;
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Docs Page Errored", {
        "Path": properties.path,
        "Error Code": properties.errorCode,
        "Client": sysClient,
        "Version": sysVersion,
        }, "Pjs0MGxPME", "34e042e4d14cf388e917a678968cfa23b16173fcca2d6acffffd6fc76ae99c6a");
    }
    // destination SegmentInspectorForDocs
