...
To get the Avo generated Python file you must be a member of an Avo workspace with a Python source. Ask for an invite from a colleague or create a [new workspace](https://www.avo.app/onboarding)
...
> Learn more about group analytics [here](/data-design/groups)
