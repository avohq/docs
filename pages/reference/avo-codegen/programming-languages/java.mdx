...
To get the Avo generated Java file you must be a member of an Avo workspace with a Java source. Ask for an invite from a colleague or create a [new workspace](https://www.avo.app/onboarding)
