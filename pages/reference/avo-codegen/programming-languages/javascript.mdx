...
The actual parameters depend on your tracking plan setup, see the parameters explanation in [the reference below](/implementation/reference/javascript#initavo).
...
- `[avoLogger]`: optional custom implementation of the logger. Can be used to disable logs. [Find the code snippet here](/implementation/custom-loggers#javascript).
...
`avoLogger`: custom implementation of the logger. [Find the code snippet here](/implementation/custom-loggers#javascript).
