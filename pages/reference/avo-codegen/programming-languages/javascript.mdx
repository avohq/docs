...
The actual parameters depend on your tracking plan setup, see the parameters explanation in <Link passHref href="/implementation/reference/javascript#initavo">the reference below</Link>.
...
- `[avoLogger]`: optional custom implementation of the logger. Can be used to disable logs. <Link passHref href="/implementation/custom-loggers#javascript">Find the code snippet here</Link>.
...
`avoLogger`: custom implementation of the logger. <Link passHref href="/implementation/custom-loggers#javascript">Find the code snippet here</Link>.
