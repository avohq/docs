...
extension SnowplowDestination: AvoSnowplowDestination {
    ...
    func trackPageView(pageName: String) {
        Snowplow.getDefaultTracker().track(ScreenView(name: title))
        // Learn more: https://docs.snowplow.io/docs/collecting-data/collecting-from-own-applications/mobile-trackers/installation-and-set-up/ios-tracker/#setting-up
    }
