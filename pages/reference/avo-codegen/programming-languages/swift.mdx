...
This page documents the single-file Swift output. Avo can also emit Swift in a "library" shape that splits the runtime from per-source types — see [Library codegen](/reference/avo-codegen/library-codegen).
</Callout>
