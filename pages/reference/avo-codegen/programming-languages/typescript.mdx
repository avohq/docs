...
const snowplowDestination = {
  make: function (env: string) {
    ...
    // Learn more: https://docs.snowplow.io/docs/sources/trackers/web-trackers/
  },
  trackSelfDescribingEvent: (
    ...
    // Learn more: https://docs.snowplow.io/docs/sources/trackers/web-trackers/tracking-events/
  },
