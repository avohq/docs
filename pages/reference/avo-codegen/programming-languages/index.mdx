...
For Kotlin, Swift, and TypeScript sources, Avo can also emit code in a "library" shape that splits the runtime from per-source types. See [Library codegen](/reference/avo-codegen/library-codegen) for the file layout and migration steps.
