...
To get the Avo generated Objective-C file you must be a member of an Avo workspace with an Objective-C source. Ask for an invite from a colleague or create a [new workspace](https://www.avo.app/onboarding).
