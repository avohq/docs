...
- `logPage`: If you call an Avo Function for an event with the [Log Page View](/data-design/avo-tracking-plan/events#log-page-view) action in the Tracking Plan, this callback will be invoked.
