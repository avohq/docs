...
```json
{
  ...
  "events": [
    ...
    },
    {
      "id": "KxcSTbeTj",
      "name": "button_pressed",
      "description": "When a user presses a button on the app",
      "triggers": [],
      "tags": ["Tier 3 - UI"],
      "categories": ["ujPLZEoj9"],
      "actions": [],
        ...
        "eventProperties": {
          ...
          "properties": {
            ...
            "button_label": {
              "id": "wAtfDzKQEY",
              "index": 1,
              "description": "The text on the button as seen by the user",
              "nameMapping": [],
              "isSystem": false,
              "context": {},
              "type": "string"
    ...
    },
    {
      ...
      "description": "When a user completes a search",
      "triggers": [],
      "tags": ["Tier 2 - Product"],
      "categories": ["wDR6HdP7z"],
      "actions": [],
      "sources": [
        {
          "id": "WmAiFg1DR",
        ...
        "eventProperties": {
          ...
          "properties": {
            "search_term": {
              "id": "hWvlLV5G9x",
              "index": 0,
              "description": "The term used to complete a search",
              "nameMapping": [],
              "isSystem": false,
              "context": {},
              "type": "string"
          ...
          "additionalProperties": false,
          "required": ["search_term", "app_name", "app_version"]
        }
      }
    },
    {
      "id": "FLcYab-wM",
      "name": "app_installed",
      "description": "When a user first opens the app",
      "triggers": [],
      "tags": ["Tier 1 - Customer/Revenue"],
      "categories": ["ujPLZEoj9"],
      "actions": [],
    ...
    },
    {
      "id": "5eYj0JckP",
      "name": "order_placed",
      "description": "When an order has been placed by a customer",
      "triggers": [],
      "tags": ["Tier 1 - Customer/Revenue"],
      "categories": ["KUZGzImDf"],
      "actions": [],
      "sources": [
        {
          "id": "g8jALgEm8",
        ...
        "eventProperties": {
          ...
          "properties": {
            ...
            "order_total_usd": {
              "id": "OxYb5LiYR",
              "index": 1,
              "description": "Total cost for the order (ex tax + shipping) in USD",
              "nameMapping": [],
              "isSystem": false,
              "context": {},
              "type": "string"
            ...
            "order_items": {
              "id": "VIErVoXme",
              "index": 2,
              "description": "An array of product objects that contain the order items",
              "nameMapping": [],
              "isSystem": false,
              "context": {},
              "type": "array",
            ...
            "order_tax_usd": {
              "id": "U4Ce_L656",
              "index": 3,
              "description": "Total tax in USD payable on the order",
              "nameMapping": [],
              "isSystem": false,
              "context": {},
              "type": "number"
            },
            "order_total_shipping_usd": {
              "id": "V9ndt9dYl",
              "index": 4,
              "description": "Total shipping cost payable in USD",
              "nameMapping": [],
              "isSystem": false,
              "context": {},
              "type": "string"
            },
            "order_guaranteed_delivery_date": {
              "id": "UeJ98YTT1",
              "index": 5,
              "description": "Date the order is guaranteed to be delivered by",
              "nameMapping": [],
              "isSystem": false,
              "context": {},
              "type": "string"
    ...
    },
    {
      ...
      "description": "When a placed order has been confirmed",
      "triggers": [],
      "tags": ["Tier 1 - Customer/Revenue"],
      "categories": ["KUZGzImDf"],
      "actions": [],
    ...
    },
    {
      ...
      "description": "When an order has been dispatched to the customer",
      "triggers": [],
      "tags": ["Tier 1 - Customer/Revenue"],
      "categories": ["KUZGzImDf"],
      "actions": ["revenue"],
    ...
    },
    {
      ...
      "description": "When an order has been successfully delivered",
      "triggers": [],
      "tags": ["Tier 1 - Customer/Revenue"],
      "categories": ["KUZGzImDf"],
      "actions": [],
...
- The `properties` array has been renamed to `eventProperties` in the `event.rules` object in the event.
...
- The `userProperties` array has been added to the `event.rules` object
- The `groupProperties` array has been added to the `event.rules` object
- The `isSystem` field has been added to property object, set to true for properties that are system properties in Avo.
