...
| `x-avo-containsPii` | Events | Whether the event contains any properties marked as PII |

These fields round-trip through the [Import API](/reference/public-api/import-tracking-plan), as long as the custom field and PII type definitions exist in the target workspace.
