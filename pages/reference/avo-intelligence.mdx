...
- **Product images**: screenshots you add to a journey. Only images you explicitly opt in for AI trigger generation are sent to the AI provider.
- **Triggers**: trigger names and descriptions, whether written by you or AI‑generated for a journey. Only triggers you explicitly opt in for AI trigger generation are sent to the AI provider.
- **Events**: names, synonyms, descriptions
