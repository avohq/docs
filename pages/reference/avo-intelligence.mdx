...
Enable Avo Intelligence to unlock current AI-powered features like Smart Search. As we introduce new functionality, we’ll notify you in advance if additional types of data would be shared with AI models. This allows Avo to share your Tracking Plan data (e.g., event names, property names, descriptions, and metrics) with OpenAI models.
