...
<Callout type="info" emoji="💡">
  In stdio mode (Claude Code), the workspace ID is persisted to disk. The response tells you what to do for your specific client to make it permanent across sessions.
</Callout>
...
Get exact before/after code diffs for all changed events on a branch, for a specific source.
