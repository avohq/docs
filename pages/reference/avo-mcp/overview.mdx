...
<Callout type="warning" emoji="🚧">
  The Avo MCP is currently in **beta**. A new `save_items` tool for write operations is available but currently under construction — only the `create` operation is functional, and access is gated behind an alpha feature flag. [Contact us](mailto:support@avo.app) if you'd like early access to write capabilities.
</Callout>
...
- Create new tracking plan items (alpha — [contact us](mailto:support@avo.app) for access)
