...
- **`search`** semantic mode caps at 20 results per call (default 10). Filter mode caps at 500 results (default 10). Journey listings (`itemType: "journey"`) return up to 100 per page (default 25); use `pageToken` to paginate.
