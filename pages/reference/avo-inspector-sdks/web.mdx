...
Run the following command to generate a P-256 (ECIES) key pair:
...
This will output:
- **Public key** (130-character hex string starting with `04`) - Provided to the Inspector SDK for encrypting property values
- **Private key** (64-character hex string) - Used by you to decrypt values in the Inspector Debugger
