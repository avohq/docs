...
Save your private key in a secure location like 1Password or another secrets manager. You'll need this to [decrypt values in the Inspector Debugger](/inspector/inspector-debugger#decrypting-property-values). Never share or expose your private key.
