...
<Callout type="info" emoji="💡">
  Property value validation is available for version 5.2.6+ of the iOS Inspector SDK. If you are using an older version, please update to the latest version.
</Callout>
