...
> 💡 **What is a Custom Destination?** <br />
...
Now let's create a custom destination for every SDK we want to use in our Source. Head back to the Connections tab and click "Add Destination". To configure a destination:
...
Repeate this process for every data destination you have in your app.
...
/>
<center>
  <i>Source configured to send to three Custom Destinations</i>
</center>
