...
We recommend using a combination of <Link passHref href="best-practices/organizing-metrics-and-events#a-namecategoriesa-categories"><a>categories and metrics</a></Link> to do so.
...
You can use the description field in the category to document your goals and higlights of the discussions from the purpose meeting. Here you have the flexibility to format your goals and discussions as you like. We like to document important finding such as the topic of the meeting, the problem that the feature or improvement is addressing and of course the goals.
