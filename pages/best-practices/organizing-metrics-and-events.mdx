...
- <a href="#goals-and-metrics">Metrics</a>
...
Categories are a way to create a organized structure for events and metrics. It is useful to create
...
After going throught that thought process, it should be clearer which events and
