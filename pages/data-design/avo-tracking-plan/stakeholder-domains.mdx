...
In Avo, you can assign one or multiple domains as stakeholders to events and event variants in your tracking plan. This is vital for large organizations sharing a schema registry, to better define areas of accountability and ownership. It makes it clear which parts of the tracking plan are relevant to each function or team within the organization and – more importantly – streamlines the workflow for when changes are suggested on shared data structures.
