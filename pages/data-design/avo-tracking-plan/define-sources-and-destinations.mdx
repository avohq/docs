...
The System Properties section allows you to configure the presence of all [system properties](/data-design/avo-tracking-plan/properties#system-properties) for this particular source in one place. This section appears right below the events table in the source overview.
