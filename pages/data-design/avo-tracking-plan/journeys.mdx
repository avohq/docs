...
Connections link a [journey step](/data-design/avo-tracking-plan/journeys#journey-step) to a [journey trigger](/data-design/avo-tracking-plan/journeys#journey-triggers). There are two ways to connect journey steps and triggers:
...
1. Fill in the details for each [journey step](/data-design/avo-tracking-plan/journeys#journey-step), one-by-one:
    ...
    - Add [annotations](/data-design/avo-tracking-plan/journeys#image-annotations) to the image to highlight specific areas of the image that are important to track
