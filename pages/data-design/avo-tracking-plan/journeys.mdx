...
**Copy and paste** works for both journey steps and triggers. Select one or more items on the canvas, copy them, and paste to duplicate them. This is useful when you need to create similar steps or triggers across your journey.
