...
- **AI generation**: Use the AI menu above a journey step to generate triggers with an optional custom prompt
...
Image annotations allow you to mark specific areas within a journey step image and connect those annotations directly to triggers. This is useful when you want to precisely indicate where in the UI an action occurs.
...
- **Rectangle annotation (click and drag)**: Click and drag on the image to create a rectangle annotation. The rectangle can be connected from any side. This is useful when annotating larger areas like carousels, swimlanes, or content sections.
