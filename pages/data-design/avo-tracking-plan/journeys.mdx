...
The journey trigger is automatically added to the event or variant details, with the image from the journey step.
...
- **is set**: The property is [always sent](/data-design/avo-tracking-plan/properties#configuring-when-properties-are-required-or-optional) on the event or variant and must have a value. This is the only operator available for properties set as always sent for the event or variant.
