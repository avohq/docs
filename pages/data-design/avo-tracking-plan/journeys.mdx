...
For a full walkthrough of building journeys on the canvas, see [Creating a journey](#creating-a-journey). Learn more about pricing for AI actions in [Agentic data design](/data-design/avo-tracking-plan/agentic-data-design).
...
- A connection from a [journey step](/data-design/avo-tracking-plan/journeys#journey-step) to another journey step is purely visual and does not connect the journey step to the event or variant connected to the journey step. Helpful to visualize how a user flows thought the journey and to get [relevant triggers](/data-design/avo-tracking-planguides/agentic-data-design#generate-journey-triggers) for each journey step based on the next step in the journey.

Connections help the AI to generate relevant triggers for each journey step based on the subsequent journey step(s). See more about generating triggers with AI and cost in the [Agentic data design](/data-design/avo-tracking-plan/agentic-data-design) documentation.
...
1. Order the images into the desired order visualizing the user journey and [connect](/data-design/avo-tracking-plan/journeys#connections) them to each other for the AI to [generate relevant triggers](/data-design/avo-tracking-plan/agentic-data-design#generate-triggers) for each step
1. Fill in the details for each [journey step](/data-design/avo-tracking-plan/journeys#journey-step), one-by-one:
    ...
    - Use the placeholder [trigger](/data-design/avo-tracking-plan/journeys#event-triggers) to either [generate a trigger with AI](/data-design/avo-tracking-plan/agentic-data-design#generate-triggers) or create one manually
5. Fill in the details for each trigger, one-by-one:
    ...
    - [Connect](/data-design/avo-tracking-plan/journeys#connections) the trigger to the [event](/data-design/avo-tracking-plan/events) or [event variant](/data-design/avo-tracking-plan/event-variants) connected to the journey step, either using the [AI menu](/data-design/avo-tracking-plan/agentic-data-design#connect-events-and-variants) or manually using "Connect event/variant" button on the trigger
