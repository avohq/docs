...
- **is**: The property value should be equal to the value(s) specified
  ...
  - If *(not set)* is deselected, then the property is required and must have a value.
...
- **is set**: The property is required on the event  and must have a value. This is the only operator available for properties set as always sent for the event or variant.
- **is not set**: The property is not allowed on the event and should not have a value
