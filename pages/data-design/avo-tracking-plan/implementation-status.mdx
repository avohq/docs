...
![Implementation status in a tracking plan](/images/workspace/tracking-plan/implementation-status.png)
...
![Event always sent correctly using Avo Codegen](/images/workspace/tracking-plan/functions-implementation-status.png)
...
![Event always sent correctly in a previous version](/images/workspace/tracking-plan/inspector-implementation-status.png)
...
![Event never sent correctly with dev in the last 7d](/images/workspace/tracking-plan/dev-inspector-status.png)
