...
- **Add or remove property bundles**: Property bundles can be added or removed from variants, just like individual properties
...
Variants now appear directly in the Events view, next to their base events. You can filter by event label, base event, variant, global events, or unlabeled items to quickly find what you're looking for.
