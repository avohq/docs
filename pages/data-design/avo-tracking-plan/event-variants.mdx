...
On the Enterprise plan, [custom field](/data-design/avo-tracking-plan/governance/custom-fields) values are inherited from the base event and can't be overridden on a variant.
