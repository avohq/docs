...
![The Custom Fields section on property details, with the required Priority single-select dropdown open](/images/governance/custom-fields-event-details.png)
