...
![Image shows how allowed values on a property](/images/property_enum.png)
...
![Image shows how allowed property values can be enabled or disabled on each event and source from property details](/images/property_enum_edit_in_property.png)
