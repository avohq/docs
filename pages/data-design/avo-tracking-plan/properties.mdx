...
<center>
  <img
    src={'/images/property_presence_per_event.png'}
    width="100%"
...
<center>
  <img
    src={'/images/property_presence_per_source_and_event.png'}
    width="100%"
    alt="Image shows how to change property presence between events"
  />
</center>
...
<center>
  <img
    src={'/images/property_enum_source_specific.png'}
    width="100%"
...
<center>
  <img
    src={'/images/replace-property-with-feature.png'}
    width="100%"
...
<center>
  <img
    src={'/images/workspace/properties/snowplow-context-example.png'}
    width="60%"
