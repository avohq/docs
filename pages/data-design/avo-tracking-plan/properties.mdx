...
![Image shows how to change property presence between events](/docs/images/property_presence_per_event.png)
...
![Image shows how to change property presence between events](/docs/images/property_presence_per_source_and_event.png)
...
![Image shows how allowed property values enumeration](/docs/images/property_enum.png)
...
![Image shows how allowed property values can be enabled or disabled on each source](/docs/images/property_enum_source_specific.png)
...
![Image shows the option to replace property with another property from a property's context menu](/docs/images/replace-property-with-feature.png)
...
![Example of a Snowplow context definition in Avo](/docs/images/workspace/properties/snowplow-context-example.png)
