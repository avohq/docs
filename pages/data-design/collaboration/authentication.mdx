...
- <a href="#emailpassword--google-login">Email/Password + Google Login</a>
- <a href="#google-sso">Google SSO</a>
- <a href="#saml-sso">SAML SSO</a>
...
- Okta: <a target="_blank" rel="noopener noreferrer" href="https://help.okta.com/oag/en-us/Content/Topics/Access-Gateway/add-app-saml-pass-thru-add-okta.htm">Add an Okta SAML application</a>
- Google: <a target="_blank" rel="noopener noreferrer" href="https://support.google.com/a/answer/6087519?hl=en">Set up your own custom SAML application</a>
- Active Directory: <a target="_blank" rel="noopener noreferrer" href="https://docs.microsoft.com/en-us/azure/active-directory/manage-apps/add-application-portal">Add an enterprise application</a>
