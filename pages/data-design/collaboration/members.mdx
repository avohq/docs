...
|----------------------------------------|---------|--------|--------|-------|
| View tracking plan                     |         | ✅      | ✅      | ✅     |
| Pull generated code using the Avo CLI  |         | ✅✳️     | ✅      | ✅     |
| Comment                                |         | ✅      | ✅      | ✅     |
...
✳️ Viewers can pull code using the CLI on the team and enterprise plans. On the free plan, only editors can pull code.
...
Codegen access is not a role that you ca
