...
3. Use the Avo Codegen provided in the generated code to implement your events in your source code. The <Link passHref href="/workspace/implement#a-nameimplement-actionsa-implement-events"><a>Codegen tab</a></Link> in your workspace provides code snippets for each event.
