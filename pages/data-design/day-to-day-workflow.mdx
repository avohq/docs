...
For teams that are using Avo Codegen to implement their events, the typical implementation workflow looks like this:
...
3. Use the Avo Codegen provided in the generated code to implement your events in your source code. The <Link passHref href="/workspace/implement#a-nameimplement-actionsa-implement-events"><a>Functions tab</a></Link> in your workspace provides code snippets for each event.
