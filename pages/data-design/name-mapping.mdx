...
<video
  ...
  width="100%"
  autoPlay
  src={'/images/best-practices/name-mapping/event-name-mapping.mp4'}
...
<video
  ...
  width="60%"
  autoPlay
  src={'/images/best-practices/name-mapping/property-name-mapping.mp4'}
...
<video
  ...
  width="100%"
  autoPlay
  src={'/images/best-practices/name-mapping/name_mapping_per_event.mp4'}
...
<center>
  <img
    src={'/images/best-practices/name-mapping/event-name-mapping-marketing.png'}
    width="75%"
...
<center>
  <img
    src={'/images/best-practices/name-mapping/event-name-mapping-big-event.png'}
    width="75%"
...
<center>
  <img
    src={'/images/best-practices/name-mapping/property-name-mapping-marketing.png'}
    width="75%"
...
<center>
  <img
    src={'/images/best-practices/name-mapping/property-name-mapping-event-and-user.png'}
    width="75%"
...
<center>
  <img
    src={'/images/best-practices/name-mapping/property-name-mapping-user-email.png'}
    width="75%"
