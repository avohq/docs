...
In the case where multiple name mappings are defined for the same property name, Avo priorizes the name mappings such that the first available mapping in the following list is the one that is used:
