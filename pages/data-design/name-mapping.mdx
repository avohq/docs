...
4. Select "Add Name Mapping" (if you can't see that option in the menu your workspace might not have access to it yet. Contact us to request access)
5. Type in the property name spelled like you want it to appear in the analytics destinations
...
<video
  ...
  width="100%"
  autoPlay
  src={require('../../images/best-practices/name-mapping/name_mapping_per_event.mp4')}
