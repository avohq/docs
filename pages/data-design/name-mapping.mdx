...
<video
  ...
  width="100%"
  autoPlay
  src={require('../../images/best-practices/name-mapping/event-name-mapping.mp4')}
...
<video
  ...
  width="60%"
  autoPlay
  src={require('../../images/best-practices/name-mapping/property-name-mapping.mp4')}
...
<center>
  <img
    ...
    width="75%"
    alt="Event name mapping for a destination"
  />
</center>
...
<center>
  <img
    ...
    width="75%"
    alt="Property name mapping for a destination"
  />
</center>
...
<center>
  <img
    ...
    width="75%"
    alt="Property name mapping for same name propertie"
  />
</center>
