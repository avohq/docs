...
![Archive option on an event in Avo](/images/workspace/archive.png)
...
![Restore item from archive from the Activity Log in Avo](/images/workspace/restore-archive.png)
...
![Restore item from archive from the branch review screen](/images/workspace/tracking-plan/diff-view-unarchive.png)
