...
- Categories: visual grouping across events, variants, properties, and metrics; items can belong to multiple categories and categories are shared across items
...
Categories provide intuitive, visual groupings across Events, Variants, Properties, and Metrics, making navigation and planning easier. Items can belong to multiple shared categories, and these categories can be published to destinations that support them (for example, Mixpanel and Amplitude) so your analytics tools mirror the same grouping. Use categories to group events, properties, and metrics for an intuitive overview of your tracking plan and to filter views by product area, journey, or feature set.
...
| --- | --- | --- | --- | --- | --- | --- |
| Global/Local Workspaces | Central governance with local flexibility | ❌ | ✅ | ✅ | ✅ | ✅ |
| Stakeholders | Ownership & dependencies | ❌ | ✅ | ✅ | ✅ | ✅ (Webhook) |
