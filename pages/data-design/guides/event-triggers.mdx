...
<center>
  <img
    src={'/docs/images/best-practices/triggers/different-visuals-for-platforms.png'}
    width="75%"
...
<center>
  <img
    src={'/docs/images/best-practices/triggers/multiple-call-sites.png'}
    width="75%"
...
<center>
  <img
    src={'/docs/images/best-practices/triggers/fat-events.png'}
    width="75%"
...
<center>
  <img
    src={'/docs/images/best-practices/triggers/diff-view.png'}
    width="75%"
    alt="Multiple triggers for user actions within an event"
  />
</center>
...
<center>
  <img
    src={'/docs/images/best-practices/triggers/single-trigger.png'}
    width="75%"
