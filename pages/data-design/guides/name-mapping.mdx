...
<center>
  <img
    src={'/docs/images/best-practices/name-mapping/event-name-mapping-marketing.png'}
    width="75%"
...
<center>
  <img
    src={'/docs/images/best-practices/name-mapping/event-name-mapping-big-event.png'}
    width="75%"
...
<center>
  <img
    src={'/docs/images/best-practices/name-mapping/property-name-mapping-marketing.png'}
    width="75%"
...
<center>
  <img
    src={'/docs/images/best-practices/name-mapping/property-name-mapping-event-and-user.png'}
    width="75%"
...
<center>
  <img
    src={'/docs/images/best-practices/name-mapping/property-name-mapping-user-email.png'}
    width="75%"
