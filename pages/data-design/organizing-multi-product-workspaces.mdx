...
- Genre specific events – a category per group of events that are applicable for specific genres or subject matter (in a game exaple there could be "Battle events", "Puzzle events" etc.)
...
*Example tracking plan for a game compnay with three games in one Avo Workspace.*
...
*Example tracking plan for a game compnay with three games in one Avo Workspace filtered to view only events sent from Game A and tagged for the Discovery team.*
