...
To organize the events and properties; sources, categories, tags and event property groups can be used. All of those ways to organize can also be used to filter, to create a relevant view for each use case.
...
**Event property groups** can be used in a similar way as the categories, grouping properties together that are commonly used together on events
