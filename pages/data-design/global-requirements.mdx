...
![Image shows a new global event on the global workspace branch review screen](/images/data-design/global-branch-reciew.png)
...
When a global branch is merged in the global workspace, it is pushed to each local workspace on branches containing the changes for each respective workspace. Thes branches will appear in the branches overview screen in each local workspace and are labeled as “global”.
