...
**Recommended alternative**: Instead of requiring admin approval for all changes, create a stakeholder team for your central data team and make them a stakeholder in all events they want to review. Configure their stakeholder-specific settings to require their review for items they are stakeholders in. This approach provides:

- **Same oversight capability** - Central data team can review all changes they care about
- **Preserves ownership** - Product teams maintain ownership of their events
- **Granular control** - Central data team can choose which events to be stakeholders in
- **Better notifications** - Targeted notifications instead of reviewing every single change
- **Flexible governance** - Easy to adjust review requirements without changing workspace settings

**Example workflow**: 
1. Product teams own events related to their features
2. Central data team is added as a stakeholder to events they want oversight on
3. Central data team's stakeholder settings require their approval for stakeholder items
4. Both product team (as owner) and central data team (as stakeholder) become required reviewers
...
Options include:
- **Automatically add as required reviewer** - The team will be automatically added as a required reviewer for the branch
...
Understanding how approval settings interact is important for configuring your workflows effectively:

1. **Workspace-level settings take precedence** - The "Require approval from owning stakeholders" workspace setting overrides individual stakeholder team configurations
2. **Protected main branch is required** - Most approval workflow features require protected main branch to be enabled first
3. **Multiple requirements combine** - If you have both admin-only approval and stakeholder approval enabled, branches need approval from both admins and relevant stakeholder teams
