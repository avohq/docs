...
Building a tracking plan is a team sport. Getting feedback from your team on the changes you're making to the tracking plan helps with building alignment and keeping the plan consistent. Approval worksflows are a powerful tool for the peer-review process. Typical workflow looks something like this:
...
The branch status is changed on the [tracking plan changes page](docs/workflow/review), accessible by clicking "View Changes" next to the branch status and below the branch name.
