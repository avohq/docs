...
![Protecting the main branch](/docs/images/protected-main-branch.png)
...
![Required admin approval](/docs/images/admin-approval.png)
...
![Multiple approvals required](/docs/images/num-required-approvals.png)
