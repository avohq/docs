...
In addition to workspace-wide Slack notifications, individual stakeholder teams can receive targeted notifications when branches impact their stakeholder items.
...
4. Configure notification preferences in the stakeholder team settings:
   - **As impacted owner** - Notifications when the team owns events being modified
   - **As impacted stakeholder** - Notifications when the team is a stakeholder in events being modified
   - **As stakeholder reviewer** - Notifications when manually added as a reviewer
