...
The code changes screen helps your team quickly and accurately implement tracking plan changes on a branch. It is one of the three review tabs. Navigate to a branch, select _View changes_ in the sidebar, then open the _Code changes_ tab. You can even share it with someone outside your Avo workspace using the public sharing feature.
