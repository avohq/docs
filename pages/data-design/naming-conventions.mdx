...
2. **[Inspector](https://www.avo.app/inspector) indicates "rogue" events and properties that don't match your tracking plan**
   ...
   > ** It's impossible to ship events or properties with names that don't match your tracking plan when you implement using Avo Codegen, but, when companies adopt Avo, they often have multiple product teams and years of analytics tracking code in place.*
