...
<Callout type="info"> To connect you Segment project to Avo need to find your [Segment write key](https://segment.com/docs/guides/setup/how-do-i-find-my-write-key/).</Callout>
...
Please [contact us](/help/troubleshooting) if you are unsure of what is
...
For detailed instructions on how to set up a custom destination, please see our [destinations docs](/implementation/destinations).
