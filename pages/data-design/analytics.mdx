...
For detailed instructions on how to set up a custom destination, please see our <Link passHref href="/implementation/destinations"><a>destinations docs</a></Link>.
