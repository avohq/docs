...
The most common use cases include keeping track of a company, organization, account or a team using your product.

### Linking events to groups

In other cases, when users do not permanently belong to a group, it might make sense to only link certain events to groups.
...
will allow you to calculate Group retention or Group conversion rates for example,
