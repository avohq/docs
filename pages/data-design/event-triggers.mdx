...
5. Select the sources that the trigger applies to
     - If no source is specified, the trigger will default to "source independent" and be included in the implementation instructions and Avo functions for all sources on the event.
