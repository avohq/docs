...
![Connections Screen](/docs/images/workspace/nav-sources.png)
...
![Add Source button](/docs/images/add-source.png)

Then you’ll see a configuration dialog, define necessary config and press “Create Source”.

![Source configuration](/docs/images/source-configuration.png)
...
![Web source details](/docs/images/web-source.png)
...
![Source configuration](/docs/images/import-completed-event.png)
...
![Edit events list on a source](/docs/images/workspace/connection-setup/edit-events-list-on-source.png)

and then check or uncheck the events you want to add/remove on the modal that appears.

![Check or uncheck events to add/remove from events list](/docs/images/workspace/connection-setup/check-events-for-source.png)
...
![Check or uncheck events to add/remove from events list](/docs/images/workspace/connection-setup/connections-inspector-setup.png)
...
![Listening for the first event](/docs/images/workspace/connection-setup/inspector-listening.png)
...
![Listening for the first event](/docs/images/workspace/connection-setup/inspector-receiving-events.png)
...
![Avo Codegen Setup Status](/docs/images/workspace/connection-setup/connections-avo-functions-setup.png)
...
![Avo Codegen listening for the first initialization](/docs/images/workspace/connection-setup/avo-functions-listening.png)
...
![Avo Codegen successfully initialized](/docs/images/workspace/connection-setup/avo-functions-receiving-events.png)
...
![Destinations Interface config in Avo Codegen Setup tab](/docs/images/data-design/destinations-interface-config.png)
...
![Add Destination button](/docs/images/add-destination.png)
...
![Destination configuration](/docs/images/destination-configuration.png)
...
![Web source details](/docs/images/workspace/configure-destination-per-event-per-source.png)
