...
Check out the Type Safe Code, unit tests and CI part of this documentation to learn more on <Link passHref href="/implementation/avo-functions-overview"><a>how to set up the Avo functions</a></Link>.
