...
Learn more about Destination Interface and Avo Managed destinations in the <Link passHref href="/implementation/destinations"><a>Destinations in Avo Functions doc</a></Link>.

<center>
  <img
    src={require('../../images/data-design/destinations-interface-config.png')}
    alt="Destinations Interface config in Avo Functions Setup tab"
    width="60%"
  />
</center>
