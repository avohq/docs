...
To review the changes on your branch, click the _View changes_ button in the workspace sidebar. There are two review modes, one for tracking plan changes and another for [code changes](/data-design/branches/code-changes). 
