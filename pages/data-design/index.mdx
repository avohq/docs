...
![Implementation status in a tracking plan](/docs/images/workspace/nav-tracking-plan.png)

_Example tracking plan in Avo_

### What's next?

Start using Avo to manage your tracking plan by following our [quickstart guide](/data-design/quick-start)
