...
<video
  ...
  width="100%"
  autoPlay
  src={require('../../images/best-practices/getting-started-to-design-data/navigate-to-metrics.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={require('../../images/best-practices/getting-started-to-design-data/create-metric.mp4')}
  alt="Create a metric"
/>
...
<video
  ...
  width="100%"
  autoPlay
  src={require('../../images/best-practices/getting-started-to-design-data/add-metric-to-category.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={require('../../images/best-practices/getting-started-to-design-data/selecting-metric-type.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={require('../../images/best-practices/getting-started-to-design-data/add-existing-events-to-metric.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={require('../../images/best-practices/getting-started-to-design-data/new-event-from-metric.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={require('../../images/best-practices/getting-started-to-design-data/navigate-to-events.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={require('../../images/best-practices/getting-started-to-design-data/configuring-an-event.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={require('../../images/best-practices/getting-started-to-design-data/add-new-property-to-event.mp4')}
...
- <Link passHref href="/data-design/object-properties"><a>object</a></Link> (available upon request): only dictionary or nested object structures are allowed, learn more about objects in Avo <Link passHref href="/data-design/object-properties"><a>here</a></Link>
...
<video
  ...
  width="100%"
  autoPlay
  src={require('../../images/best-practices/getting-started-to-design-data/configuring-an-event-property.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={require('../../images/best-practices/getting-started-to-design-data/add-existing-property-to-event.mp4')}
...
Now you know how to define and maintain your metrics and events in Avo and it's time to learn <Link passHref href="/data-design/define-sources-and-destinations"><a>how to manage sources and destinations</a></Link>.
