...
<video
  ...
  width="100%"
  autoPlay
  src={'/images/best-practices/getting-started-to-design-data/opening-a-branch.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={'/images/best-practices/getting-started-to-design-data/navigate-to-metrics.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={'/images/best-practices/getting-started-to-design-data/create-metric.mp4')}
  alt="Create a metric"
/>
...
<video
  ...
  width="100%"
  autoPlay
  src={'/images/best-practices/getting-started-to-design-data/add-metric-to-category.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={'/images/best-practices/getting-started-to-design-data/selecting-metric-type.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={'/images/best-practices/getting-started-to-design-data/add-existing-events-to-metric.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={'/images/best-practices/getting-started-to-design-data/new-event-from-metric.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={'/images/best-practices/getting-started-to-design-data/navigate-to-events.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={'/images/best-practices/getting-started-to-design-data/create-event.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={'/images/best-practices/getting-started-to-design-data/configuring-an-event.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={'/images/best-practices/getting-started-to-design-data/add-new-property-to-event.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={'/images/best-practices/getting-started-to-design-data/configuring-an-event-property.mp4')}
...
<video
  ...
  width="100%"
  autoPlay
  src={'/images/best-practices/getting-started-to-design-data/add-existing-property-to-event.mp4')}
