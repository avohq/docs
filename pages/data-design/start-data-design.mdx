...
Now you know how to define and maintain your metrics and events in Avo and it's time to learn how to [review branch changes](/workflow/review) and [request implementation](/workflow/request-implementation). If you haven't set up your sources and destinations yet, now is a good time to learn how [sources and destinations](data-design/define-sources-and-destinations) are defined.
