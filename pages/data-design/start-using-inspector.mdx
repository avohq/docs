...
<Link passHref href="/workspace/inspector"><a>Inspector tab description</a></Link>
<br/>
<br/>
...
If you’re not using one of the supported CDPs you can send events data with an SDK. It will require one time setup and new app release and takes 2-30 minutes, depending on the developer’s experience. We recommend asking a developer that is familiar with the existing event tracking setup to help with this setup.
