...
Avo Inspector analyzes tracking calls made by your application across platforms and provides an overview of their structure and volumes in the Inspector dashboard, without collecting or processing any user data.
...
If you send your events through a CDP (Customer Data Platform) you can configure the CDP to route the event metadata to Avo Inspector by setting up an Avo Inspector destination.
...
You can add Avo Inspector to a web page with an HTML tag. This option works for the users of the Google Tag Manager and other tag managers.
