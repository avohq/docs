...
There are two Inspector overviews available for your incoming data and issues, the <Link passHref href="/workspace/inspector/inspector-issues-view"><a>Issues view</a></Link> and the <Link passHref href="/workspace/inspector/inspector-events-view"><a>Events view</a></Link> – and you can set up <Link passHref href="/workspace/inspector/inspector-slack-alerts"><a>Slack Alerts</a></Link> to be notified about new issues.
...
<center>
  <img
    src={'/images/workspace/nav-inspector.png'}
    width="100%"
    alt="Inspector tab"
  />
</center>
