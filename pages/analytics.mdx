...
Please <Link href="/help/troubleshooting">contact us</Link> if you are unsure of what is
...
For detailed instructions on how to set up a custom destination, please see our <Link href="/custom-destinations"><a>custom destination docs</a></Link>.
