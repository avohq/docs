...
For detailed instructions on how to set up a custom destination, please see our <Link passHref href="/custom-destinations"><a>custom destination docs</a></Link>.
