...
- [Mixpanel Lexicon](#mixpanel-lexicon): Sync your analytics schema
  to Mixpanel Lexicon
- [Amplitude Govern](#amplitude-govern): Sync your analytics schema
  to Amplitude Govern
...
- [Slack](#slack): Configure notifications to be sent to a Slack
  channel.
...
[Publish to Amplitude Govern](/publishing/publishing/amplitude-govern) to sync your analytics schema to downstream
