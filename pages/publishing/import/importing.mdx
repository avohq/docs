...
When using the [Import API](/reference/public-api/import-tracking-plan), you can pass the `importMethod` query parameter with a value of `addOnly` (default) or `addAndUpdate`. See the [Import API documentation](/reference/public-api/import-tracking-plan#import-methods) for detailed behavior of each method.
