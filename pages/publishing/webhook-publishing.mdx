...
layout: 'guide'
title: 'Webhook'
# abstract: 'Publishing your tracking plan to a Webhook'
---
...
| stakeholderDomains | array(StakeholderDomain)                              | Array of stakeholder domains associated with this event       |
...
| ?examples          | array(string)                | Example values that match the validation pattern                |
| ?operations        | array(string)                | Array of property ops, e.g. "SnowplowContext"                   |

##### StakeholderDomain Model

| Attribute | Type    | Description                                                       |
| :-------- | :------ | :---------------------------------------------------------------- |
| id        | string  | Unique identifier of the stakeholder domain                      |
| name      | string  | Display name of the stakeholder domain                           |
| isOwner   | boolean | Whether this domain is designated as the owner of the entity     |
