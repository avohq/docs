...
| stakeholderDomains | optional array(\{ id, name }) | Key present if any event or variant has stakeholder domains. Array of all stakeholders attached to event or variant |
