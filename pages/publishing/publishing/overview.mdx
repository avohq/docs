...
![Avo Publishing Integration](/docs/images/publishing.svg)
...
![Creating a new Publishing Integration](/docs/images/workspace/nav-publishing.png)

Then you can select the type of integration you want to create and give it a name.

![Creating a new Publishing Integration](/docs/images/workspace/integrations/create-integration.png)
...
![Publishing filter to publish only events sent from Web to Amplitude](/docs/images/auto_publishing.png)
...
![Publishing filter to publish only events sent from Web to Amplitude](/docs/images/publish_filter.png)
