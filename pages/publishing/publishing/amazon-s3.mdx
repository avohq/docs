...
You can choose the JSON shape Avo serializes. The **Payload Format** dropdown offers three formats, each documented in detail on the [Webhook payload format docs](/publishing/publishing/webhook-publishing#payload-format):
