...
Reduce scope of the breaking changes to the minimum.

- beta.1

Features available in the private beta release include publishing of the Adobe Experience Events and all the changes are treated as breaking changes for now.
