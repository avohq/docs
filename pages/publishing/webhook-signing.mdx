...
![The image shows a webhook integration and a button at the top labeled Webhook Secret which if clicked reveals the secret](/docs/images/signing-secret.png)
