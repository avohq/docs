...
The casing validation does allow for strings separated by semicolon (":" and " : "). For example, "cartSidebar : addToCart" is identified as camel case.
...
The casing validation does allow for strings separated by semicolon (":" and " : "). For example, "product_name : updated" is identified as snake case.
