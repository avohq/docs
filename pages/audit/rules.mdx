...
Checks for properties that do not belong to any category when the rule is enabled. Categories group the properties in the properties view and makes the tracking plan more navigable.
