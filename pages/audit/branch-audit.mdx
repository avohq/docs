...
<Callout type="info" emoji="💡">Validation of [advanced event name rules](/audit/advanced-event-naming-rules) is currently not supported in the branch audit or the [tracking plan audit](/audit/overview).</Callout>
