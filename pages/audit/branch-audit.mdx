...
<Callout type="info" emoji="💡">Validation of [advanced event name rules](audit/advanced-event-naming-rules) is currently not supported in the branch audit or the tracking plan audit(/inspector/start-using-inspector).</Callout>
...
<Callout type="info" emoji="💡">The branch audit only audits the _branch_. If you want to identify issues in the tracking plan check out the [Tracking Plan Audit](/audit/overview). If you want to identify issues in your current tracking implementation and data streams, check out [Tracking Observability](/inspector/start-using-inspector).</Callout>
