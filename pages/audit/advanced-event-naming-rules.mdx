...
- ensure they use allowed values for certain components of the event name
- prevent them from using blocked values for certain components of the event name
...
Similar to allowed values, blocked values enable users to define a list of prohibited values for every event name component. This feature helps prevent the use of specific terms or phrases that may be inconsistent with your naming conventions.
...
- Add "Allowed values" for both the "Object" and "Action" event name components
- Add "Blocked values" for both the "Object" and "Action" event name components
