...
<Callout type="info" emoji="💡">Advanced event naming rules are available on our [enterprise plan](avo.app/pricing)</Callout>
...
![Navigating to audit config step 1](/images/audit/audit config nav 2.png)
...
![Name components](/images/audit/name components.png)
...
![Adding allowed values when creating an event](/images/audit/add allowed value)
...
![Separators](/images/audit/separators)
...
![Guardrails](/images/audit/guardrails)
