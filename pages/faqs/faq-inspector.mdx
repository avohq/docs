...
No, you don’t! The <Link passHref href="/implementation/avo-inspector-sdk-reference"><a>Avo Inspector SDK</a></Link> is designed to not require any changes to your existing tracking code. <Link passHref href="/implementation/start-using-inspector"><a>Read more on setting up the SDK here</a></Link>.
