...
Yes! Inspector provides you with immediate observability into your tracking plan and you can even build your tracking plan based on live data via Inspector. To get going quickly, check out our [Inspector Quickstart](/inspector/start-using-inspector)
.
