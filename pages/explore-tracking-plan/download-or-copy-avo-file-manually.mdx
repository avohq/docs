...
> 💡 **Codegen** produces type-safe wrappers around your analytics event tracking calls,
> to make it easier and faster to implement your analytics tracking calls. <Link passHref href="/implementation/devs-101"><a>Read more about Codegen here.</a></Link>
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/images/generate-avo-file-manually.png'}
