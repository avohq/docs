...
> Currently the web visual debugger is only available when you use <Link passHref href="/implementation/avo-codegen-overview"><a>Avo Codegen</a></Link>.
...
<center>
  <img
    height="500"
    src={'/images/web-debugger-example.png'}
...
Ask a developer to integrate the debugger into your application and provide a way to toggle it following <Link passHref href="/implementation/setup-mobile-debugger"><a>this guide</a></Link>.

## <a name="look"></a> How it looks

<img
  src={'/images/mobile-debugger.png'}
...
<tr>
 <td style={{"padding":10}}>
  <video
    ...
    width="100%"
    autoPlay
    src={'/images/android-debugger-example.mp4')}
 ...
 <td style={{"padding":10}}>
  <video
    ...
    width="100%"
    autoPlay
    src={'/images/ios-debugger-example.mp4')}
 ...
 <td style={{"padding":10}}>
  <video
    ...
    width="100%"
    autoPlay
    src={'/images/rn-debugger-example.mp4')}
    alt="React native debugger example"
  />
 </td>
</tr>
