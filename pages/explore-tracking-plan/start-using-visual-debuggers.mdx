...
> Mobile debuggers are bundled with the Inspector SDK on iOS and Android.
...
<tr>
 <td style={{"padding":10}}>
  <video
    ...
    width="100%"
    autoPlay
    src={require('../../images/android-debugger-example.mp4')}
 ...
 <td style={{"padding":10}}>
  <video
    ...
    width="100%"
    autoPlay
    src={require('../../images/ios-debugger-example.mp4')}
 ...
 <td style={{"padding":10}}>
  <video
    ...
    width="100%"
    autoPlay
    src={require('../../images/rn-debugger-example.mp4')}
    alt="React native debugger example"
  />
 </td>
</tr>
