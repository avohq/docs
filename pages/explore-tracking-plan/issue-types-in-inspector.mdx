...
- <a href="#unextpected-event">Unexpected event (not in tracking plan)</a>
- <a href="#unextpected-property">Unexpected property (not in tracking plan)</a>
...
- When a property is required in the tracking plan but sometimes or alway missing
...
### <a name="unextpected-event"></a>Unexpected event

Alert when an event that is not defined in the tracking plan is detected by the Inspector

_**Example:** Event Signup Completedd not found in Tracking Plan._

### <a name="unextpected-property"></a>Unexpected property

Alert when an property that is not defined in the tracking plan is detected by the Inspector
