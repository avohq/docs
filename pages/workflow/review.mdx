...
Step 3. Assign one or more reviewers. Click “Assign reviewer” and find the person or [stakeholder team](/data-design/avo-tracking-plan/stakeholder-domains) (alpha) you want to review your branch. The reviewer will receive an email to let them know, and if you have the Avo Slack integration set up for your workspace, they will be @ mentioned in a Slack notification.
