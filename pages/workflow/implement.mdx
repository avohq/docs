...
<div className={styles.row}>
  <PageLink
    ...
    callToAction={new CallToAction('/implementation/read-implementation-diff')}
  />
</div>
...
3. Use the functions provided Avo Codegen to implement your events in your source code. [The Codegen tab in your workspace](https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/implement/fs/WUFObVFR4PVbZGtT1hQ5) provides documentation and code snippets for each event
