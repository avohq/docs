...
1. Use the [Branch Code Changes](/data-design/branches/code-changes) as a task list for what events need to be implemented or updated changed to align with your tracking plan changes.
2. Open a git branch to implement your analytics tracking changes in your product's codebase.
3. Implement the changes in your existing analytics tracking code, using the schema details provided by Avo as your reference.
