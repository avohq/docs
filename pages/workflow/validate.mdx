...
### Validate with the Inspector implementation status in the Tracking Plan
...
### Validate with Avo Functions implementation status in the tracking plan
...
<center>
  <img
        width="100%"
        src={require('../../images/workflow/5.validate/pill_with_functions.png')}
        alt="hover the pill to see implementation status"
  />
</center>
