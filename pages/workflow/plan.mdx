...
- Check for existing properties that you can use instead of defining new ones. You can search for existing events, properties, and variants using the command pallette (cmd+k on Mac, ctrl+k on Windows) or browse all your properties on the Properties screen in the Tracking Plan.
