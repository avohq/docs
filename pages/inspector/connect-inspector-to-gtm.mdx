...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={'/docs/images/server-gtm-download.png'}
...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={'/docs/images/server-gtm-templates.png'}
...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={'/docs/images/server-gtm-template-new.png'}
...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={'/docs/images/server-gtm-import.png'}
...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={'/docs/images/server-gtm-tags.png'}
...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={'/docs/images/server-gtm-tag-new.png'}
...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={'/docs/images/server-gtm-tag-configuration.png'}
...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={'/docs/images/server-gtm-avo-inspector-setup.png'}
