...
2. **Add your public key** — In the Tag Configuration, paste your hex public key into the **Public Encryption Key** field. Leave it empty to continue without encryption.
...
If you don't need encryption, you can skip step 3 — the v2 SDK works identically to v1 without a key.
