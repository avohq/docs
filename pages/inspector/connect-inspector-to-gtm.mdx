...
<Callout type="info" emoji="💡">
  **Optimizing bundle size for production?** If you're using the NPM package and bundle size is a concern in production, consider using the [lite build](/reference/avo-inspector-sdks/web#installation-option-3-lite-build-production-only) (~5.2 KB gzipped). Use the full build in dev/staging environments for the complete Inspector Debugger experience including property value validation and session filtering.
</Callout>
