...
**Step 1: [Download our GTM recipe here]()**
...
The recipe contains the following tags and variables:
- Tags
    - Avo Inspector Init
    - Avo Inspector Send
- Variables
...
**Step 4: When testing change the environment to dev**  
The environment is set to production by default. When testing, we recommend using your development GTM container and send the data to your Inspector development environment. You do that by opening the Avo Inspector Init tag in GTM, find the inspector.__ ENV __ key and change the value from 'prod' to 'dev'.

![Changing environment in the Inspector Init tag.](/images/inspector/web-gtm-change-env.png)

**Step 5: Publish the GTM container**

**Step 6: See your data flowing into the Inspector**  
If you are testing in the development environment, the data will start appearing almost immediately. To see development data, open the Inspector Events view and change the environment to dev:

![Accessing dev data in the Inspector events view.](/images/inspector/accessing-dev-data.png)

If you have published your production container to send data to the production environment in Inspector, we recommend opening the [Issues view](/inspector/inspector-issues-view) to see the issues Inspector detects. You can also open the [Events view](/inspector/inspector-events-view) in production to see all events that are coming in, with or without issues.
