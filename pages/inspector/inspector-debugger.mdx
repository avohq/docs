...
<Callout type="info" emoji="💡">
  To use the Inspector Debugger, the Inspector needs to be installed in your application. See the [Inspector installation overview](/inspector/inspector-installation-overview) for instructions.
</Callout>
