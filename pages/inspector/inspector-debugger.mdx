...
Property values are encrypted end-to-end for privacy and security. You can always see if there is an issue related to the value but to see the actual values you need to decrypted them using your private key.
...
2. **Store your private key securely** - Keep your private key in a secure location like 1Password or another secrets manager. You'll need this key to decrypt values in the debugger
