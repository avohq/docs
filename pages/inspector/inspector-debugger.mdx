...
<Callout type="info">
  Property value validation is currently only available for the Inspector Web SDK and Segment integration. Other platforms coming soon. Reach out to support if you need property value validation for other platforms. 
</Callout>
