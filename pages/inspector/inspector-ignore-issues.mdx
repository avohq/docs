...
Seeing unwanted alerts after merging your Avo branches? Talk to us! Click the chat bubble at the bottom right, or send an email to beta@avo.sh.

When you're in the beta, you'll find a new option under the "Merge branch" button on the branch review screen. This helps you stop unwanted issues and alerts from old release versions.
