...
The most obvious reason is that you have not yet installed Inspector at all, or on the source that you are looking for. [install Inspector](/docs/inspector/inspector-installation-overview) on the source for which you'd like to see issues.
