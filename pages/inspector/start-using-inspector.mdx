...
You can add both events and properties from Inspector, both via the issues view (where you can bulk import events and properties) and the events view (where you can add individual events). Learn more [here](/inspector/add-events-from-inspector).

## How to send metadata to Inspector
