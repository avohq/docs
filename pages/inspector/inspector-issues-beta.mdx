...
<div style={{ maxWidth: 400, marginTop: '1.5rem' , margin: 'auto'}}>
...
![Image shows the Slack native modal where a Slack workspce and a channel have been selected and the Allow button highlighted.](/images/inspector/alerts-successfully-connected-to-saved-view.png)
...
Are you not in the beta, but are interested in trying out our new issues infrastructure and alerts for saved views? Reach out to us via the chat bubble right here in the lower right corner or email us at beta@avo.sh!