...
We've built a new infrastructure for generating issues, that allows for more flexibility and speed. That means that loading your issues will be faster and we're able to provide more detailed information in issue details. In addition we've added alerts for saved views.

## How to get access to the beta

Are you not in the beta, but are interested getting faster and better issues and alerts for saved views? Reach out to us via the chat bubble right here in the lower right corner or email us at beta@avo.sh!
...
## How to use alerts for saved views
