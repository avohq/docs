...
Before setting up Inspector alerts for Slack, ensure you:
- Have Admin access to your Slack workspace, permission to install apps or have someone that has these permissions to help you
- An Avo workspace with Inspector enabled
- Create at saved view for the filtered view you want to get alerted on
