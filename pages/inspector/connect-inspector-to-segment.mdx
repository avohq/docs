...
![Data flow from Segment to Avo Inspector](/docs/images/chart-segment-to-inspector.png)
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    height="80"
    src={
      '/docs/images/guide-segment-to-inspector/segment-new-function-button.png'
    }
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={
      '/docs/images/guide-segment-to-inspector/inspector-development-env.png'
    }
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={
      '/docs/images/guide-segment-to-inspector/segment-connect-destination.png'
    }
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={
      '/docs/images/guide-segment-to-inspector/segment-destination-toggle.png'
    }
