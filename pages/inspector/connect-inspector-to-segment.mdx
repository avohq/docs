...
1. **Generate encryption keys** - Run the following command in your terminal to generate a public/private key pair:
...
2. **Store your private key securely** - Save your private key in a secure location like a password manager. You'll need this to decrypt values in the [Inspector Debugger](/inspector/inspector-debugger#decrypting-property-values). Never share or expose your private key with a third party.
