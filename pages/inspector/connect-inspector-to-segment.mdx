...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/docs/images/chart-segment-to-inspector.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    width="100%"
    src={'/docs/images/workspace/nav-inspector-sources-highlighted.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/docs/images/add-source.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    height="400"
    src={'/docs/images/guide-segment-to-inspector/source-setup.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/docs/images/guide-segment-to-inspector/code-snippets.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/docs/images/guide-segment-to-inspector/segment-functions-menu.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    height="80"
    src={'/docs/images/guide-segment-to-inspector/segment-new-function-button.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={
      '/docs/images/guide-segment-to-inspector/segment-create-destination-function.png'
    }
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/docs/images/guide-segment-to-inspector/code-snippet-in-segment.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/docs/images/guide-segment-to-inspector/create-function.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    height="500"
    src={'/docs/images/guide-segment-to-inspector/use-sample-event.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/docs/images/guide-segment-to-inspector/segment-output-success.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/docs/images/guide-segment-to-inspector/inspector-development-env.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    height="500"
    src={'/docs/images/guide-segment-to-inspector/source-in-inspector.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/docs/images/guide-segment-to-inspector/segment-connect-destination.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={
      '/docs/images/guide-segment-to-inspector/segment-pick-source-for-function.png'
    }
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/docs/images/guide-segment-to-inspector/segment-destination-toggle.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/docs/images/chart-avo-to-segment-to-inspector.png'}
