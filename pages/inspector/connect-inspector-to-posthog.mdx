...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    height="400"
    src={'/docs/images/guide-posthog-to-inspector/source-setup.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/docs/images/guide-posthog-to-inspector/avo-plugin.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/docs/images/guide-posthog-to-inspector/insert-api-key.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/docs/images/guide-posthog-to-inspector/logs.png'}
