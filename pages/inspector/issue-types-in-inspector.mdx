...
Property value issues are detected when you have [property value validation](/inspector/inspector-debugger#decrypting-property-values) enabled. Property values are sent encrypted to Avo and can be decrypted locally in the [Inspector Debugger](/inspector/inspector-debugger#decrypting-property-values) using your private key.
