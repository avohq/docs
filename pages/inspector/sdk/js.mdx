...
# Avo Inspector Javascript SDK for Web And React Native
...
> - `appVersion` - your application version. A lot of Inspector features rely on versioning and you need to provide a comparable string here to get value from them. We recommend using semantic versioning or integers.
...
```
See supported schema types <Link to="/inspector/sdk#supported-types">here</Link>.
