...
- <a href="#event-tracking">Sending event schemas to Avo Inspector</a>
- <a href="#other-methods">Other methods</a>
- <a href="#visual-inspector">Using the Visual Inspector</a>
- <a href="#segment-middleware">Auto inspection with Segment SDK</a>
...
Call __**one of the methods**__ in this section every time an event is tracked.
...
See <Link to="/inspector/sdk#standalone-usage">this</Link> for details about event schema structure and schema types.
...
Visual inspector is actually our <Link to="/mobile-debuggers">Mobile Debugger</Link> integrated in the Avo Inspector SDK. 
...
See <a href="https://segment.com/docs/connections/sources/catalog/libraries/mobile/android/#middlewares">Segment android middleware docs</a> for more information.
