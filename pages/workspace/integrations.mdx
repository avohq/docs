...
- <Link
  ...
  : Document to which analytics tools and destinations your data should be sent
  in your Avo Tracking plan{' '}
- <Link href="/implementation/start-using-avo-functions" passHref>
    Implement tracking for your destinations with Avo Codegen
  </Link>
  : Type-safe implementation based on your Avo Tracking Plan, for all your
  analytics tools and destinations
