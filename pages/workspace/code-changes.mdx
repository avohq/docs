...
The code changes screen helps your team quickly and accurately implement tracking plan changes on a branch. You can find it by navigating to a branch, selecting *View changes* in the sidebar and then clicking the *Code changes* tab. You can even share it with someone outside your Avo workspace using the public sharing feature.

<img
  src={require('../../images/code-changes/code-changes.png')}
  width="100%"
...
<img
  src={require('../../images/code-changes/code-changes-share.png')}
  width="306px"
  alt="Overview of code changes"
/>
...
<img
  src={require('../../images/code-changes/code-changes-public.png')}
  width="100%"
  alt="Overview of code changes"
/>
...
<img
  src={require('../../images/code-changes/code-changes-shared.png')}
  width="306px"
  alt="Overview of code changes"
/>
