...
Read more about how to <Link passHref href="/data-design/multiple-sources-on-avo-branches"><a>manage branches with multple sources</a></Link> to keep your Avo main branch in sync with your git main branch.
