...
We recommend using semantic versions **("1.0.0")** which get incremented on every release, but any type of incremental string or number will do (e.g. build number). Providing a version to the Inspector will help get the cleanest output from the status report and help you understand how your tracking is performing in your latest versions.
