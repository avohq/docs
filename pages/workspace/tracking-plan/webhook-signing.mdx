...
Avo generates a unique secret key for each publishing webhook endpoint. If you use multiple webhooks, you must obtain a secret for each one you want to verify the signature for.
<p>
  <img
