...
> 💡 A property can only belong to a single group. That's to avoid a conflict between groups when using Avo Codegen
...
- <Link passHref href="/data-design/object-properties">
    <a>object</a>
  </Link> _(<Link passHref href="/help/troubleshooting">
    <a>reach out to us</a>
  </Link> for access)_
