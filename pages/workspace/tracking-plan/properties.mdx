...
An property is defined in the event details within the relevant <Link passHref href="/workspace/tracking-plan/events#a-nameactionsa-actions"><a>actions</a></Link> or in the properties view.
