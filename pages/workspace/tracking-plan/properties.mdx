...
Snowplow.logEvent({
  "data": {
    ...
    {
      "data": {
        "page_name": properties.pageSnowplowContext.pageName,
        "page_path": properties.pageSnowplowContext.pagePath,
        "page_category": properties.pageSnowplowContext.pageCategory,
      }
    }
  ]
)
