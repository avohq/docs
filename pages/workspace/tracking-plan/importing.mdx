...
1. Export your Tracking Plan from Mixpanel. Open up Mixpanel Lexicon (in the top right corner of your Mixpanel workspace click Data Management > Lexicon) and then click the export button:
...
| Is Property Requierd?        | True if the property should always be sent with your event        | true                                       |
