...
- **If the properties should be merged and you are in a position to reset your tracking plan**: Unify the description in your import file and re-run the import. This will result in the properties being merged on import.
