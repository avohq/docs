...
You can import your <Link passHref href="#importing-event-schemas"><a>event schemas</a></Link>, <Link passHref href="#import-user-properties"><a>user properties</a></Link>, <Link passHref href="#import-group-properties"><a>group properties</a></Link>, and <Link passHref href="#import-name-mapping"><a>name mapping</a></Link>.
...
| Column Name  | Description                                    | Example value  |
| :----------- | :--------------------------------------------- | :------------- |
| Pinned Value | The pinned value of the property on this event | [optional] iOS |
