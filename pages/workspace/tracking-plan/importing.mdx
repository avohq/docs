...
destinations if:
>
> ***a/ You have legacy event structures in specific analytics tools***, 
which you can't change now because you need to data continuity in these 
tools. 
>
> ***b/ Analytics destinations require specific event or property names*** 
...
<Link passHref href="/help/troubleshooting#contact-us"><a>Reach out</a></Link> if 
you want to apply a large set of name mappings for event and property names.
