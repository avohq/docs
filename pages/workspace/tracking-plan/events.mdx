...
- A <Link passHref href="/data-design/defining-descriptive-events-and-properties#events-1"><a>_Description_</a></Link> including the timing of when the event should be sent as well as other useful implementation details (optional but highly recommended)
...
- The <Link passHref href="/data-design/organizing-metrics-and-events#a-namecategoriesa-categories"><a>_Categorie(s)_</a></Link> that the event is a part of (optional)
