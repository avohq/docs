...
<Link passHref href="/workspace/tracking-plan/publishing">Publishing integrations</Link> can be used for exporting your tracking plan, either one of, or a recurring publishing export using auto-publishing.
...
3. In the "Payload preview" section click "Click to view payload preview". When the preview has loaded you can either copy or download the JSON file. You can find more details on the format of the JSON in the <Link passHref href="/workspace/tracking-plan/publishing#tracking-plan-model">Publishing docs</Link>.
