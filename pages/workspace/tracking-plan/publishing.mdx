...
- <a href="#snowplow">Snowplow Data Structures</a>
...
> 💡 The Protocols integration currently supports the established [Config API](https://segment.com/docs/api/config-api/). If you are only able to use the new _Public API_, please reach out to us.
...
## <a name="snowplow"></a> Snowplow Data Structures
...
- **Snowplow Vendor Name**: The vendor name of your Snowplow schemas.
- **Snowplow Access Token**: The secret access token to update your Snowplow data structures.

### Publishing to Snowplow

You can publish your Avo tracking plan into Snowplow with the publishing integration.
