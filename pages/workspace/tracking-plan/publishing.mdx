...
- **mParticle Plan ID**: The ID of the Data Plan to update. To view available plans press "Data Master" -> "Plans" in the navigation panel in the mPartcile UI. You'll see the list of your plans. Plan ID is the string below the plan name.
