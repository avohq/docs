...
> 💡 The Protocols integration currently only supports the established [Config API](https://segment.com/docs/api/config-api/). If you are only able to use the new _Public API_, please reach out to us.
