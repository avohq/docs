...
- **Description**: This is the description as provided in Avo
  - Coming Soon: We're currently working on including the event triggers in the description published to Protocols
...
Currently Avo does not publish user or group properties into Protocols. If you'd like to publish user or group properties, please let us know, and we'll invite you to the beta when it goes live.
...
You can provide your own [vendor](https://docs.snowplowanalytics.com/docs/understanding-tracking-design/understanding-schemas-and-validation/#:~:text=%E2%80%9Cvendor%E2%80%9D%20%E2%80%93%20This%20usually%20refers,events%20and%20contexts%20(e.g.%20com.) value via the "Vendor" input in the publishing integration config.

| Attribute | Type                         | Description                                                                                                                                                                                                               |
| :-------- | :--------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| schemas   | array(Snowplow Event Schema) | Schema for every event in your tracking plan, following the [Snowplow Schema](https://docs.snowplowanalytics.com/docs/understanding-tracking-design/understanding-schemas-and-validation/#the-anatomy-of-a-schema) format |
