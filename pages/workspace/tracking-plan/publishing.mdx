...
We tried to update an event that doesn't exist in your Amplitud Govern Schema. If this error occurs for all of the events you are attempting to publish it might indicate that your Amplitude Govern Schema has not been initialized. Learn more about initializing your Amplitude Govern Schema in [the Amplitude Govern docs](https://help.amplitude.com/hc/en-us/articles/360047579451-Initialize-and-manage-the-Schema). If your Govern Schema has been initialized, and the error persists, please contact support.
...
We tried to update an item that doesn't exist in your Amplitud Govern Schema. This might be caused by an internal error. Please reach out to support so we can help you resolve the issue.
