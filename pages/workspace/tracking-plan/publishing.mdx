...
Avo will create a new version of your data plan in mParticle every time you publish. If you'd like to see Avo manage the versions of your plans in mParticle differently, please <Link passHref href="/help/troubleshooting"><a>reach out to us</a></Link>!
