---
layout: 'guide'
title: 'Send data from Google Tag Manager to Avo Inspector'
---
...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={require('../../images/server-gtm-download.png')}
...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={require('../../images/server-gtm-templates.png')}
...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={require('../../images/server-gtm-template-new.png')}
...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={require('../../images/server-gtm-import.png')}
...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={require('../../images/server-gtm-tags.png')}
...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={require('../../images/server-gtm-tag-new.png')}
...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={require('../../images/server-gtm-tag-configuration.png')}
...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={require('../../images/server-gtm-avo-inspector-setup.png')}
    alt="Navigation to the inspector key in Avo"
    height="100"
  />
</center>

5. Choose which environment this tag is reporting from. Inspector distinguish development, staging and production environments. Production is designed for high volumes, while development and staging are designed for quick response. You'll see you dev and staging events in the Inspector dashboard almost instantly, while the production events can take up to an hour to appear
