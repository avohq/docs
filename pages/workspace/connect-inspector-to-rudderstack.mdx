...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    height="400"
    src={'/images/guide-rudder-to-inspector/source-setup.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/images/guide-rudder-to-inspector/rudder-transformations-menu.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/images/guide-rudder-to-inspector/create-transformation.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    height="500"
    src={'/images/guide-rudder-to-inspector/rudderstack-transformation-test.png'}
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/images/guide-rudder-to-inspector/rudder-destinations-menu.png'}
    alt="RudderStack navigation to the transformations menu"
  />
</center>
...
<center style={{ marginBottom: 16 + 'px' }}>
  <img
    src={'/images/guide-rudder-to-inspector/rudder-destination-sources.png'}
