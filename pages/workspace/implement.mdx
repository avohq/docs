...
## <a name="init-avo"></a> Initialize Avo

Before you can use the library to log events and do other actions, you must call the initAvo function. We recommend doing this as early as possible in your app lifecycle. More detailed instructions on how to initialize Avo can be found in the implement tab.
...
When the event has been seen valid in development, a green check mark appears by the event name:
