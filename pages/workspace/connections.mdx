...
- <a href="#destinations">Destinations</a>
  ...
  - <a href="#appsflyer">AppsFlyer</a>
  - <a href="#facebook">Facebook Analytics</a>
  - <a href="#firebase">Firebase Analytcs</a>
  - <a href="#fullstory">FullStory</a>
  - <a href="#intercom">Intercom</a>
  - <a href="#mixpanel">Mixpanel</a>
  - <a href="#segment">Segment</a>
  - <a href="#custom">Custom Destination</a>
...
platform, programming language and <Link
to="/concepts/destinations">Destinations</Link> to send to.
...
It's also sometimes possible to use a custom destination for language - analytics pairs that are not supported by Avo yet. Please <Link to="/help/troubleshooting">contact us</Link> if you are unsure of what is the best solution for you.

Detailed instructions on how to set up a custom destination can be found in our <Link to="/custom-destinations">custom destination docs</Link>.
