...
- The <Link href="/workspace/connections#sources">_Source(s)_</Link> that the event should be sent from
- The <Link href="/workspace/workspace#actions">_Actions(s)_</Link> associated with the event
- The <Link href="/workspace/workspace#metrics">_Metrics(s)_</Link> related to the event
...
Event properties are sent with the event in the <Link href="/workspace/tracking-plan#log-event">event call</Link>. 
...
User properties are updated with the <Link href="/workspace/tracking-plan#update-user-props">Update User Properties action</Link>.
...
Read more about how to <Link href="/best-practices/organizing-metrics-and-events">organize metrics and events</Link>.
