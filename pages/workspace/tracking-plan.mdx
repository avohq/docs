...
1. <a href="#events">Events</a>
    ...
    - <a href="#event-defintion">Event Definition</a>
    - <a href="#actions">Actions</a>
    
      - <a href="#identify-user">Identify User</a>
      - <a href="#update-user-props">Update User Properties</a>
      - <a href="#log-event">Log Event</a>
      - <a href="#log-revenue">Log Revenue</a>
      - <a href="#log-page-view">Log Page View</a>
      - <a href="#unidentify-user">Undentify User</a>
2. <a href="#properties">Properties</a>
    
    - <a href="#event-properties">Event Properties</a>
    - <a href="#user-properties">User Properties</a>
    - <a href="#system-properties">System Properties</a>
    - <a href="#property-groups">Property Groups</a>
    - <a href="#property-types-and-constraints">Property Types and Constraints</a>
3. <a href="#metrics">Metrics</a>


## <a name="actions"></a> 1. Events
...
- The <Link to="/workspace/connections#sources">_Source(s)_</Link> that the event should be sent from
- The <Link to="/workspace/workspace#actions">_Actions(s)_</Link> associated with the event
- The <Link to="/workspace/workspace#metrics">_Metrics(s)_</Link> related to the event
...
1. <a href="#identify-user">Identify User</a>: Amplitude, Segment, Mixpanel and Fullstory
2. <a href="#update-user-props">Update User Properties</a>: Amplitude, Segment, Mixpanel and Fullstory
...
6. <a href="#unidentify-user">Undentify User</a>: Amplitude, Segment, Mixpanel and Fullstory
...
<a href="#revenue-amplitude">Amplitude</a>, <a
href="#revenue-segment">Segment</a> and <a href="#revenue-mixpanel">Mixpanel</a>
support tracking revenue specifically. It's recommended to add the Log Revenue action
with events that represent a successful purchase, such as `Purchase Completed`
...
## <a name="properties"></a> 2. Properties
...
Event properties are sent with the event in the <Link to="/workspace/tracking-plan#log-event">event call</Link>. 
...
User properties are updated with the <Link to="/workspace/tracking-plan#update-user-props">Update User Properties action</Link>.
...
Read more about how to <Link to="/best-practices/organizing-metrics-and-events">organize metrics and events</Link>.
