...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={require('../../images/guide-rudder-to-inspector/avo-plugin.png')}
...
<center style={{marginBottom: 16 + "px"}}>
  <img
    src={require('../../images/guide-rudder-to-inspector/insert-api-key.png')}
...
<center style={{marginBottom: 16 + "px"}}>
  <img
    height="500"
    src={require('../../images/guide-rudder-to-inspector/logs.png')}
