...
<center>
  <img
    src={require('../../../images/inspector/all-events-unfiltered-unsorted.png')}
    width="100%"
    alt="Image shows the default all issues view ordered by issues last seen."
  />
</center>
...
<center>
  <img
    src={require('../../../images/inspector/naming-and-saving-a-view.png')}
    width="100%"
    alt="Image shows a filtered view with it's naming and saving modal open."
  />
</center>
...
<center>
  <img
    src={require('../../../images/inspector/newly-saved-view.png')}
    width="100%"
    alt="Image shows a newly saved view."
  />
</center>
...
<center>
  <img
    src={require('../../../images/inspector/duplicate-saved-view.png')}
    width="100%"
    alt="Image shows a saved view saved view with the duplicate button highlighted."
  />
</center>
...
<center>
  <img
    src={require('../../../images/inspector/naming-and-saving-a-duplicated-view.png')}
    width="100%"
    alt="Image shows a saved view saved view with the name and save a duplicated view modal open and highlight."
  />
</center>
...
<center>
  <img
    src={require('../../../images/inspector/newly-saved-duplicated-view.png')}
    width="100%"
    alt="Image shows a saved view saved view with the name and save a duplicated view modal open and highlight."
  />
</center>
...
<center>
  <img
    src={require('../../../images/inspector/modified-duplicated-view.png')}
    width="100%"
    alt="Image shows a saved view saved view with the name and save a duplicated view modal open and highlight."
  />
</center>
...
<center>
  <img
    src={require('../../../images/inspector/modified-view-with-unsaved-changes.png')}
    width="100%"
    alt="Image shows a modified saved view saved view with unsaved changes."
  />
</center>
...
<center>
  <img
    src={require('../../../images/inspector/modified-view-with-saved-changes.png')}
    width="100%"
    alt="Image shows a modified saved view saved view with the Save as... modal open and highlighted."
  />
</center>
...
<center>
  <img
    src={require('../../../images/inspector/sharing-a-saved-view.png')}
    width="100%"
    alt="Image shows a saved view with the copy link button highlighted."
  />
</center>
...
<center>
  <img
    src={require('../../../images/inspector/renaming-a-saved-view.png')}
    width="100%"
    alt="Image shows a saved view with the copy link button highlighted."
  />
</center>
...
<center>
  <img
    src={require('../../../images/inspector/all-saved-views-button-highlighted.png')}
    width="100%"
    alt="Image shows a saved view with the copy link button highlighted."
  />
</center>
...
<center>
  <img
    src={require('../../../images/inspector/saved-views-overview.png')}
    width="100%"
    alt="Image shows a the Inspector Issues page with the All saved views button highlighted."
  />
</center>
...
<center>
  <img
    src={require('../../../images/inspector/archiving-a-saved-view.png')}
    width="100%"
    alt="Image shows a saved view with the copy link button highlighted."
  />
</center>
