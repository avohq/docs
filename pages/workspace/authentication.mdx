...
- <Link passHref href="#emailpassword--google-login"><a>Email/Password + Google Login</a></Link>
- <Link passHref href="#google-sso"><a>Google SSO</a></Link>
- <Link passHref href="#saml-sso"><a>SAML SSO</a></Link>
...
<center>
  <img
    width="400"
    src={require('../../images/workspace/authentication-methods.png')}
...
To enable SAML SSO for your Avo workspace, <Link passHref href="/help/troubleshooting"><a>reach out</a></Link> to us.
