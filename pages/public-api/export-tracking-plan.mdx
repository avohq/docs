...
> This endpoint requires an <Link passHref href="/public-api/authentication#authenticating-with-avo-api"><a>authorization header</a></Link> containing a service account name and secret.
