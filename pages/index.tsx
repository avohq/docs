    ...
    <div className={styles.grid}>
      ...
      <div>
        ...
        <p className={styles.text}>
          Avo is where your product analytics starts. Avo is the proactive data 
          planning and governance platform for product analytics. 
          With Avo, teams  like Patreon implement 10x faster with autogenerated 
          type safe code and unit tests, sending data exactly as planned.
        </p>

        <p className={styles.text}>
          Avo will give you and your team: <b>Better tracking plan management. 
          Tracking validation. Better analytics release workflow</b>. 
          You can adopt all three, or stop at 1 (no 
          engineering effort) or 2 (little to no engineering effort).
        </p>
        ...
        <div className={styles.row}>
          <PageLink
            image={AnalyticsManagerIcon}
            title="Define consistent event and properties across teams and platforms"
            description="Global namespace for events and properties makes sure you don't create conflicting event and property names"
            callToAction={
