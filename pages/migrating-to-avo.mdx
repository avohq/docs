...
If you don't have existing tracking or want to start from scratch, you can take a look at our <Link passHref href="/quickstart"><a>quickstart documentation</a></Link> to get started.
