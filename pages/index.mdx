...
|Data Managers|Developers|
--- | ---
|- <Link passHref href="/workspace/tracking-plan/publishing"><a>Setting up publishing and auto publishing to Segment, Amplitude, Mixpanel and webhook</a></Link>||
...
This stage requires one time setup in each of your applications. The setup is simple and shouldn't take more than 30 minutes.
...
||- <Link passHref href="/implementation/avo-tracking-plan-webhook"><a>Listen to the tracking plan changes with a webhook</a></Link>|
