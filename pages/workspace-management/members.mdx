...
\* Viewers can pull code using the CLI on the team and enterprise plans by activating a monthly active implementer seat. On the free plan, only editors can pull code. [See details below](/workspace-management/members#implementer-access-for-viewers).
</Callout>
