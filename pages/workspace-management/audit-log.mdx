...
**Example scenario**: Your weekly metrics report indicates a key conversion event decreased by 30% last Thursday. You need to determine if a tracking plan change caused the issue.
...
5. Filter by **Action** = "Updated" to see how categories evolved
...
- **Quarterly** - Comprehensive analysis of trends and patterns for strategic planning
