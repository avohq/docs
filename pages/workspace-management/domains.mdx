...
Domains give you a clear overview of areas of responsibility and ownership within your schema, by mapping out which domains are stakeholders of each event (including [event variants](/data-design/avo-tracking-plan/event-variants)) in your tracking plan and which users belong to those domains.
...
![Screenshot of the domains section in the workspace settings modal where you can create a new domain](/images/domains/creating-a-domain.png)
