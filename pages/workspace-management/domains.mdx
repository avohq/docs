...
Domains give you a clear overview of areas of responsibility and ownership within your schema, by mapping out which domains are stakeholders of each event and event variant in your tracking plan and which users belong to those domains.
...
By documenting domains as stakeholders on the events and event Variants in your tracking plan, anyone navigating your tracking plan is able to understand who is relying on which events and variants and who to loop in when changes are made or if an issue comes up.

<PageLink
  image="/docs/images/svg/analyticsmanager.svg"
  title="Stakeholder domains"
  description="Why and how to assign domains as stakeholders on events and event variants"
...
1. **The domain events:**
The events and event variants where this domain has been added as a stakeholder, indicating that the domain depends on and/or is responsible for those events and variants. 
