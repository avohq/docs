...
By documenting domains as stakeholders on the events in your tracking plan, anyone navigating your tracking plan is able to understand who is relying on which events and who to loop in when changes are made or if an issue comes up with an event.
...
### Assigning stakeholdership of events

From this view you can assign stakeholdership of multiple events in your tracking plan to the domain

1. Click “+ Add” 
1. Select the events from your tracking plan where you assign the domain as a stakeholder.
        You can filter events by category or tag to make it easier to find relevant events. 
1. Click “Add” to finish adding the events you have selected to your domain
