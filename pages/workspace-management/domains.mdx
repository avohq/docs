...
Once created, the stakeholder lead can add members and assign the "Can approve" privilege to those that should be allowed to approve branches on behalf of the stakeholder team.
All stakeholder team members can add new members and mark the stakeholder team as a stakeholder on events in the tracking plan.
Workspace admins can also manage all stakeholder teams in the workspace.
