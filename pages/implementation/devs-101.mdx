...
1.  <a href="#avo-functions-type-safe-analytics-wrappers">
...
should be triggered with an Avo Function (for example you might want to update user properties or log revenue along with logging an event), and the Avo Codegen
...
you're using the Avo Codegen or not.
...
You can use the Inspector SDK whether or not you adopt Avo Codegen, by plugging the
...
Initialize the Avo Codegen SDK with an instance of the Inspector SDK.
...
When you implement analytics via the <a href="#avo-functions-type-safe-analytics-wrappers">Avo Codegen</a>, the In-App Inspector will not only show you
