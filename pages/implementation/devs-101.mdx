...
You can view the overview of your current tracking in the [Inspector Issues View](/inspector/inspector-issues-view) and you can connect Avo Inspector to a Slack channel to receive alerts when Inspector detects
