...
- `avoLogger` (not shown in the example) - custom logger implementation to controll logs logic. Can be used to disable logs. <Link passHref href="/implementation/custom-loggers"><a>More about custom loggers</a></Link>.
