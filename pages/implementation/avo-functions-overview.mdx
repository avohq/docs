...
> 
> Learn how <Link passHref href="/implementation/destinations/managed-destinations"><a>Avo handles different tracking methods for fully Avo managed analytics SDKs</a></Link>.
> 
> Learn how <Link passHref href="/implementation/start-custom-destination#custom-destinations-overview"><a>you can implement supported tracking methods in your custom destination</a></Link>.
