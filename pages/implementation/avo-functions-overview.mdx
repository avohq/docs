...
For example, you can add "log event" action to make Avo function call a method that tracks a use event or "log revenue" to call revenue method trom the SDK.
