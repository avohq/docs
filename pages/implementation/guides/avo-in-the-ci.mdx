...
When you implement your analytics events with [Avo Codegen](/implementation/avo-codegen-overview), aka the type-safe analytics wrappers, you can run `avo status` to check where in your code base the analytics calls are made, or if they are missing.
...
- It validates tracking calls implemented with [Avo Codegen](/implementation/avo-codegen-overview), aka the Avo generated type-safe analytics wrappers.
