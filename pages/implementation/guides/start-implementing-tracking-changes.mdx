...
![Connections configuration](/docs/images/implement/branch-changes-view-button-1.png)
...
![Connections configuration](/docs/images/workspace/nav-functions.png)

*Codegen reference*

It might be useful to check the changes tab in your Avo workspace for overview while implementing.

> If you are implementing the branch in multiple codebases we recommend you to read the [Multiple sources on Avo branches](/data-design/multiple-sources-on-avo-branches) guide.
