...
Read more on <Link passHref href="/workspace/code-changes">the branch changes view</Link>.
...
> If you are implementing the branch in multiple codebases we recommend you to read the <Link passHref href="/data-design/multiple-sources-on-avo-branches">Multiple sources on Avo branches</Link> guide.
