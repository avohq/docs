...
![Implement with Codegen checkbox example](/docs/images/best-practices/avo-functions-alongside-existing-tracking/implement-with-avo-example.png)

Initiate Codegen with a [destination interface](/implementation/destinations#destination-interface-callback-methods).
