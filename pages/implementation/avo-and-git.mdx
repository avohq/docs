...
If one of the sources completes their implementation ahead of the other sources, and are merging that implementation in the main git branch, we recommend merging only that source into your Avo main branch. Read more about how to <Link passHref href="/data-design/multiple-sources-on-avo-branches"><a>manage branches with multple sources</a></Link> to keep your Avo main branch in sync with your git main branch.
