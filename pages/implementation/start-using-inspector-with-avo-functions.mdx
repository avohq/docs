...
>   href="https://github.com/avohq/ios-avo-inspector">described here</a> to analyze your tracking outside of Avo Functions, it will report the data correctly alongside the Avo Functions.
...
<p/>
To enable Avo Functions to report to Avo Inspector automatically you would need to provide an instance of Avo Inspector, <a target="\_blank" rel="noopener noreferrer" href="https://github.com/avohq/android-avo-inspector">check the quick start guide for how to create one</a>, when initializing Avo and use Avo version >= `63.10.0` and Avo Inspector SDK version >= `1.2.0`.
...
<p/>
To enable Avo Functions to report to Avo Inspector automatically you provide an instance of the Inspector when initializing Avo. This requires Avo version >= `63.10.0` and Avo Inspector SDK version >= `1.2.0`. <a target="\_blank" rel="noopener noreferrer" href="https://github.com/avohq/js-avo-inspector/">Check the quick start guide for how to create an Avo Inspector instance</a>.
...
<p/>
To enable Avo Functions to report to Avo Inspector automatically you provide an instance of the Inspector when initializing Avo. This requires Avo version >= `71.34.0` and Avo Inspector SDK version >= `0.1.0`. <a target="\_blank" rel="noopener noreferrer" href="https://github.com/avohq/node-avo-inspector">Check the quick start guide for how to create an Avo Inspector instance</a>.
...
<p/>
To enable Avo Functions to report to Avo Inspector automatically you provide an instance of the Inspector when initializing Avo. This requires Avo version >= `63.10.0` and Avo Inspector SDK version >= `1.2.0`. <a target="\_blank" rel="noopener noreferrer" href="https://github.com/avohq/js-avo-inspector/tree/react-native-node-package">Check the quick start guide for how to create an Avo Inspector instance</a>.
