...
>   href="https://github.com/avohq/ios-avo-inspector">described here</a> to analyze your tracking outside of Avo Codegen, it will report the data correctly alongside the Avo Codegen.
...
> You can use the same instance of Avo Inspector to analyze your tracking outside of Avo Codegen, it will report the data correctly alongside the Avo Codegen.
...
<p/>
To enable Avo Codegen to report to Avo Inspector automatically you provide an instance of the Inspector when initializing Avo. This requires Avo version >= `63.10.0` and Avo Inspector SDK version >= `1.2.0`. <a target="\_blank" rel="noopener noreferrer" href="https://github.com/avohq/js-avo-inspector/">Check the quick start guide for how to create an Avo Inspector instance</a>.
...
<p/>
To enable Avo Codegen to report to Avo Inspector automatically you provide an instance of the Inspector when initializing Avo. This requires Avo version >= `71.34.0` and Avo Inspector SDK version >= `0.1.0`. <a target="\_blank" rel="noopener noreferrer" href="https://github.com/avohq/node-avo-inspector">Check the quick start guide for how to create an Avo Inspector instance</a>.
...
<p/>
To enable Avo Codegen to report to Avo Inspector automatically you provide an instance of the Inspector when initializing Avo. This requires Avo version >= `63.10.0` and Avo Inspector SDK version >= `1.2.0`. <a target="\_blank" rel="noopener noreferrer" href="https://github.com/avohq/js-avo-inspector/tree/react-native-node-package">Check the quick start guide for how to create an Avo Inspector instance</a>.
