...
First of all we recommend to open your Avo workspace and navigate to the branch you are about to implement, switch to the code changes view and familiarize yourself with the changes happening.
...
Read more on <Link passHref href="/workspace/code-changes"><a>the branch changes view</a></Link>.
