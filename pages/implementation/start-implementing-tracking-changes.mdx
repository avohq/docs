...
Now you can pull the Avo Codegen from your Avo workspace.

```bash
avo pull --branch your_branch_name [SourceName]
```

> When you run Avo pull for the first time it will also initialize Avo in your project by adding an `avo.json` file, containing a pointer to your Avo workspace, source and current branch. This file should be checked into git along with the Avo Codegen file.
