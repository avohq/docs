...
Obtain the API key by opening your  <a target="_blank" rel="noopener noreferrer" href="https://www.avo.app/schemas/default/settings">Avo.app workspace settings</a>, selecting the source you want to add and then click the _Inspector Setup_ tab.
