...
Learn more in the <Link passHref href="/implementation/start-using-avo-codegen"><a>Codegen setup docs</a></Link>.
...
Learn more technical details about Codegen <Link passHref href="/implementation/avo-codegen-tech-deep-dive"><a>here</a></Link>.
