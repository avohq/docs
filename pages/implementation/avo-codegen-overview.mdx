...
- The "data designer" specifies the event structure in the <Link passHref href="/workspace">Avo Tracking Plan</Link>, and which platforms should send the event
...
Learn more in the <Link passHref href="/implementation/start-using-avo-codegen">Codegen setup docs</Link>.
