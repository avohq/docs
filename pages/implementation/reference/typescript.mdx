...
To get the Avo generated Typescript file you must be a member of an Avo workspace with a JavaScript source. Ask for an invite from a colleague or create a <a href="https://avo.app/onboarding" target="_blank">new workspace</a>
