...
- `[strict = false]`: bool defaulting to false, if true, Avo will throw an exception when it detects a tracking problem in development or staging. Note that the strict flag is ignored in production.
