...
Find destination interface snippects for different platforms and analytics destinations [in our GitHub])("https://github.com/avohq/destination-interface-code-snippets/tree/main/typescript").
