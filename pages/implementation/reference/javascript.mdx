...
- `[inspector]`: optional Avo Inspector instance. If you use Avo Inspector pass it here to make the Avo Codegen automatically report the invocations to the Avo Inspector.
...
This method allows you to provide custom implementation of the logger used by the Avo Codegen, same as the `avoLogger` parameter in the `initAvo` call.
