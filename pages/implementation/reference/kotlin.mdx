...
>   <a>Reach out</a>
> </Link> if you want to use Avo Codegen in Kotlin server

> You can force the generated code to use Kotlin Coroutines for the network calls with "--forceFeatures KotlinCoroutines" flag when running the <Link passHref href="/implementation/cli#step-3-pull-generated-analytics-wrappers-from-avo"><a>Avo CLI</a></Link>. <Link passHref href="/help/troubleshooting"><a>Let us know</a></Link> if you want to enable coroutines by default in your workspace.
...
`avoInspector: Any?`: optional Avo Inspector instance. If you use Avo Inspector pass it here to make the Avo Codegen automatically report the invocations to the Avo Inspector.
...
This method allows you to provide custom implementation of the logger used by the Avo Codegen.
