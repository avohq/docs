...
`properties`: an associated array of properties, defined in your Avo tracking plan. Properties can be of types string, int, long, float, bool, array, object and any.
