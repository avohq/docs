...
Creates the Avo object that will be used to track. This method will call the `makeWithEnv:withApiKey:` callback in all the provided destination interfaces. It will also initialize the analytics SDKs of the legacy Avo managed destinations.
