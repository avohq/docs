...
The actual parameters depend on your tracking plan setup, see the parameters explanation in <Link passHref href="/implementation/reference/objc#initAvo">the reference below</Link>.
...
This method will call the `makeWithEnv:withApiKey:` callback in all the provided <Link passHref href="/implementation/destinations#destination-interface-callback-methods">destination interfaces</Link>. It will also initialize the analytics SDKs of the legacy <Link passHref href="/implementation/destinations#avo-managed-destination-legacy">Avo Managed destinations</Link>.
