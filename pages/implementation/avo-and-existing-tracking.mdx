...
Initiate the Avo functions with a  <Link passHref href="/implementation/destinations#destination-interface-callback-methods"><a>destination interface</a></Link>.
...
- Replacing existing SDK call with a call your generated Avo Functions