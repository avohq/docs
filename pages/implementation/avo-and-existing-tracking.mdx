...
Mark the new events you want to implement with Avo as "Implement with Codegen" in the Avo workspace and they will appear as functions in the generated code.
