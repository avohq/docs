...
let myAnalyticsSDKBridge = {
  ...
  setUserProperties: (userId, userProperties) => {
    /*
      You can add User Properties to events in the Tracking Plan in Avo. When an Avo Function with attached user properties
  ...
  identify: (userId) => {
    /*
      You can add the Identify User action to events in the Tracking Plan in Avo. When calling an Avo Function that includes
  ...
  unidentify: () => {
    /*
      You can add the Unidentify User action to events in the Tracking Plan in Avo When calling an Avo Function that includes
