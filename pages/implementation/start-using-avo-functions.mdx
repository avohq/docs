...
>
> A/ If you have _**existing tracking**_ and you intend to use Avo Functions alongside an analytics SDK that's already initalized in your app and receiving data.
>
