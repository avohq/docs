...
1. [Provide the destination interface for each analytics destination](#implement-the-destination-interface)
2. [Configure in your Avo workspace](#configure-in-your-avo-workspace)
...
- [See example of a bridge interface in JavaScript.](../implementation/reference/javascript#destination-interface-example)
