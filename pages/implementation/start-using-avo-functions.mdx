...
> 
> Great if you don't have any existing tracking in place for this destination yet.
>
> If you have existing tracking in place using this SDK, you can migrate to fully Avo managed destination as soon as you've deprecated all existing calls to it that don't use Avo Functions. Note that such migration is not required if you use a self-managed destination (a custom destination).
