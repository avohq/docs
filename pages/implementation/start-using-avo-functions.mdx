...
>
> To make the workflow of updating the Avo Functions as easy as possible we built the Avo CLI. By running `avo pull [--branch my-branch] [SourceName]` the CLI will update the file containing the Avo Functions automatically.
