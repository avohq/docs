...
> If you are using the Inspector SDK on iOS and Android the Visual Debugger is bundled with it, you do not need to do this setup! See `showVisualInspector` and `hideVisualInspector` methods of the Inspector SDKs.
