...
> Make sure all the events you want to implement using Codegen have the source attached to it, where "Implement with Avo" has been checked. Learn more about how to [configure events in your tracking plan here](https://www.avo.app/docs/workspace/tracking-plan/events#sources).
...
Read more about property types later in the <Link passHref href="/implementation/avo-codegen-overview#avo-generated-file-func-parameters"><a>Codegen section.</a></Link>
