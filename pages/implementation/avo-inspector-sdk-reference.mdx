...
We recommend using semantic versions **("1.0.0")** which get incremented on every release, but any type of incremental string or number will do (e.g. build number).
