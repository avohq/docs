                ...
                "nameMapping": [
                  {
                    ...
                    "destinationId": "all" | "anotherDestinationId"
                  }
                ],
                "flags": []
              },
...
Now when you've set up a webhook we recommend to <Link passHref href="/implementation/avo-inspector-overview"><a>integrate the Avo Inspector</a></Link>.
