...
func trackSelfDescribingEvent(schema: String, data: Dictionary, 
        customContexts: List<Dictionary<schema: String, data: Dictionary>>)
...
val avo = AvoImpl(...,
    snowplowDestination = object : AvoSnowplowDestination {
        ...
        override fun trackSelfDescribingEvent(schema: String, data: Map<String, *>, customContexts: List<Map<String, Any>>) {
...
const snowplowDestination = {
  ...
  trackSelfDescribingEvent: (schema: string, data: any, customContexts: any[]): void => {
...
extension SnowplowDestination: AvoSnowplowDestination {
    ...
    func trackSelfDescribingEvent(schema: String, data: [String: Any], customContexts: [[String: Any]]) {  
        let event = SelfDescribing(schema: schema, payload: data)  

        customContexts.forEach { customContext in
            event.contexts.add(
                SelfDescribingJson(schema: customContext["schema"],
                    andDictionary: customContext["data"]))
        }
