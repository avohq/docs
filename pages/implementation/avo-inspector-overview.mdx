...
<center>
  <img
    src={'/images/workspace/connection-setup/connections-inspector-setup.png'}
    alt="Inspector Setup"
    width="75%"
  />
</center>
...
Now when you know how Inspector SDK works it's good time to implement it in your application. Here is <Link passHref href="/implementation/avo-inspector-sdk-reference">the documentation</Link>.
