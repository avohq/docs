...
- [Web](#web)
  - <Link passHref href="/implementation/reference/javascript"><a>JavaScript</a></Link>
  - <Link passHref href="/implementation/reference/typescript"><a>TypeScript</a></Link>
  - <Link passHref href="/implementation/reference/rescript"><a>Rescript</a></Link>
  - <Link passHref href="/implementation/reference/reasonml"><a>ReasonML</a></Link>
- [Mobile](#mobile)
  - [iOS](#ios)
    - <Link passHref href="/implementation/reference/objc"><a>Objective-C</a></Link>
    - <Link passHref href="/implementation/reference/swift"><a>Swift</a></Link>
  - [Android](#android)
    - <Link passHref href="/implementation/reference/java"><a>Java</a></Link>
    - <Link passHref href="/implementation/reference/kotlin"><a>Kotlin</a></Link>
...
- [Backend](#backend)
  - [Node.js](#node-js)
    ...
    - <Link passHref href="/implementation/reference/reasonml"><a>ReasonML</a></Link>
  - <Link passHref href="/implementation/reference/java"><a>Java</a></Link>
  - <Link passHref href="/implementation/reference/php"><a>PHP</a></Link>
  - <Link passHref href="/implementation/reference/python"><a>Python</a></Link>
  - <Link passHref href="/implementation/reference/ruby"><a>Ruby</a></Link>
  - <Link passHref href="/implementation/reference/csharp"><a>C#</a></Link>
...
Here is a more specific example of how you can use a destination interface in JavaScript on Web to integrate with your Google Analytics 4 SDK to implement custom event tracking with Avo.
...
let customDestination: Avo.avoCustomDestination = {
  make: (env: Avo.avoEnvType, apiKey: string) => (),
...
If you need to be able to pass an Anonymous Id from the Avo function to your destination interface, [reach out to us](https://www.avo.app/docs/help/troubleshooting) and we'll enable that functionality for your workspace. When the Anonymous Id pass through has been enabled for your workspace the destination interface will look like this:
...
to deliver an event to any analytics destination or pipeline.
...
class CustomDestination {
    public function make($env, $api_key) {
        // TODO implement
    }
    ...
    public function log_page($user_id, $page_name, $event_properties) {
        // TODO: Log page view in your analytics SDK here
    }

    public function revenue($user_id, $amount, $event_properties) {
        // TODO: Log revenue in your analytics SDK here
    }
...
Import the Avo library into your code and define a class that implements the destination interface:
...
Call the init_avo() function and pass in the destination interface implementation:

```python
avo.init_avo(options={'env': 'dev'}, custom_destination=CustomDestination())
```

where the name of the `custom_destination` parameter is the name of your destination in Avo.
