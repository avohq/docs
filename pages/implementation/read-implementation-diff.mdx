...
The type of each property is listed, can be event property, user property or group property.

### Destinations

Then we list the destinations of the event - new, removed and existing.
If an event or property has a different name that should be used for given destination, it will be listed in this section.
