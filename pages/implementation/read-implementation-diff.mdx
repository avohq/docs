...
First thing you need to know is that tracking design happens on branches. When a new feature is built, the analytics manager opens a branch in Avo and plans all the new tracking there.
