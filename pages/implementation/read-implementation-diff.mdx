...
Situated at the top of the diff view screen, you can share the changes made you can choose to copy the implementation instructions either in Markdown or in Jira's text format.


#### An example output (Markdown)
