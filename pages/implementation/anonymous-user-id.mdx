...
<Link
  ...
  passHref
>
  Learn more about the Identify action.
</Link>
...
An optional `anonymousUserId` parameter is available on demand in all server languages, <Link passHref href="/help/troubleshooting">contact us</Link> if you need to use it and don't see it in your Codegen.
