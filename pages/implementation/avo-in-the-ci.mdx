...
When you implement your analytics events with <Link passHref href="/implementation/avo-codegen-overview">Avo Codegen</Link>, aka the type-safe analytics wrappers, you can run `avo status` to check where in your code base the analytics calls are made, or if they are missing.
...
- It validates tracking calls implemented with <Link passHref href="/implementation/avo-codegen-overview">Avo Codegen</Link>, aka the Avo generated type-safe analytics wrappers.
...
[Get in touch](/help/troubleshooting) if you want to learn more about how Avo prevents analytics errors.
